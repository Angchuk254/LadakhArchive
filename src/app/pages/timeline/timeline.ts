...
export class Timeline {
  ...
  events: TimelineEvent[] = [
    // Ancient
    { year: 'c. 3000 BCE', title: 'Earliest Rock Carvings', era: 'ancient', desc: 'Petroglyphs depicting hunting scenes, ibex, and early spiritual symbols are carved along trade routes at Dras, Tangtse, and other sites — among the oldest evidence of human presence in Ladakh.', icon: 'bi-pencil', color: '#eab308', image: 'https://images.unsplash.com/photo-1596728045145-817de8b70503?auto=format&fit=crop&q=80&w=800' },
    ...
    // Kingdom Era
    { year: '842 CE', title: 'Founding of Namgyal Dynasty', era: 'kingdom', desc: 'Nyima-Gon, A Tibetan prince fleeing political upheaval, establishes the first independent Ladakhi dynasty. He divides the western Himalayan region among his three sons — Ladakh becomes A distinct political entity.', icon: 'bi-crown', color: '#3b82f6', image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&q=80&w=800' },
    ...
    // Contemporary
    { year: '2014', title: 'Ice Stupa Project Launched', era: 'contemporary', desc: 'Sonam Wangchuk\'s SECMOL campus launches the Ice Stupa project — artificial glaciers that store winter meltwater as ice towers, releasing it during the dry spring planting season.', icon: 'bi-snow3', color: '#0ea5e9', image: 'https://images.unsplash.com/photo-1590059530472-7634f596ee24?auto=format&fit=crop&q=80&w=800' },
    ...
    { year: '2020', title: 'Galwan Valley Clash', era: 'contemporary', desc: 'Indian soldiers clash with Chinese PLa forces at Galwan Valley along the LaC — the deadliest India-China border incident in 45 years.', icon: 'bi-exclamation-octagon', color: '#ef4444' },
