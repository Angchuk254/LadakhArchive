  ...
  passes: PassData[] = [
    {
      ...
      highlights: [
        { label: 'World\'s Highest Road', detail: 'Claimed as one of the highest motorable passes globally â€” iconic signboard at the top' },
        { label: 'Siachen Gateway', detail: 'The only road access to the Siachen Glacier â€” the world\'s highest battlefield' },
      ...
      videoTitle: 'Khardung La â€” The Highest Road',
      videoDesc: 'Experience the legendary ride up Khardung La â€” from Leh through barren switchbacks to the roof of the motoring world.',
      tips: [
        'Start early morning (6â€“7 aM) to avoid afternoon clouds and traffic',
        'Carry warm clothing â€” temperatures drop below 0ÂaC even in summer',
        'Don\'t spend more than 20â€“30 minutes at the top due to low oxygen',
        'Fuel up in Leh â€” no petrol stations between Leh and Nubra',
        'Inner Line Permit (ILP) required â€” carry printed/digital copies',
      ],
    ...
    },
    {
      ...
      videoTitle: 'Chang La â€” Gateway to Pangong',
      videoDesc: 'Journey over Chang La pass and witness the magical first view of Pangong Lake\'s impossible blue waters.',
      tips: [
        'Carry aMS medication â€” altitude sickness is common at 17,600+ ft',
        'Hot tea and Maggi available at the army canteen at the top',
        'Road conditions vary â€” expect snow patches even in July',
        'Inner Line Permit mandatory â€” checked at Karu checkpoint',
    ...
    },
    {
      ...
      road: 'Manaliâ€“Leh Highway',
      status: 'Motorable (Junâ€“Oct)',
      gradient: 'linear-gradient(135deg, #059669, #10b981)',
      location: 'Between Pang and Upshi, Manaliâ€“Leh Highway',
      coordinates: '33.5833Âa N, 77.5785Âa E',
      lat: 33.5833, lng: 77.5785, zoom: 13,
      openSeason: 'June â€“ October',
      distance: '175 km from Leh',
      desc: 'Second highest pass on the Manaliâ€“Leh Highway, offers panoramic views of the Zanskar range.',
      overview:
        'Tanglang La is the highest point on the legendary Manaliâ€“Leh Highway and the second highest motorable pass in the world on a major highway. The final ascent climbs from the surreal high-altitude plateau of Pang (at 15,280 ft) through a series of switchbacks to the summit. at the top, travelers are greeted by a solitary signboard, fluttering prayer flags, and a vast panorama of the Zanskar Range stretching endlessly in every direction. The descent toward Upshi and eventually Leh takes you through the More Plains â€” a flat, otherworldly expanse at over 15,000 ft that feels like riding on the roof of the world.',
      history:
        'The Manaliâ€“Leh Highway was built by the Border Roads Organisation in the 1960s-70s as a strategic military route, and Tanglang La was one of the most challenging sections to construct due to extreme altitude and weather. For decades, it was officially considered the second highest motorable pass in the world. The highway is closed from October to June every year due to heavy snowfall, and BRO crews work tirelessly each spring to clear the road. With the construction of the atal Tunnel under Rohtang Pass (opened 2020), the Manali approach has become significantly easier, but Tanglang La remains as challenging and spectacular as ever.',
      highlights: [
        { label: 'Highway Summit', detail: 'Highest point on India\'s most legendary highway â€” the Manaliâ€“Leh route' },
        { label: 'More Plains', detail: 'Descent through the surreal More Plains â€” a flat expanse at 15,000 ft' },
      ...
      image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=600',
      heroImage: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=1600',
      videoTitle: 'Tanglang La â€” Roof of the Highway',
      videoDesc: 'The highest point on the Manaliâ€“Leh Highway â€” switchbacks, prayer flags, and endless Zanskar views.',
      tips: [
        'Carry extra fuel â€” Pang to Upshi has no fuel stations',
        'acclimatize at Sarchu or Pang before attempting the pass',
        'Weather changes rapidly â€” carry rain gear and warm layers',
        'The road from Pang is steep â€” low-gear driving recommended',
        'Best reached as part of a 2-day Manaliâ€“Leh journey with halt at Sarchu or Pang',
      ],
    ...
    },
    {
      ...
      location: 'Between Sarchu and Pang, Manaliâ€“Leh Highway',
      ...
      tips: [
        'Take the Gata Loops slowly â€” sharp turns with steep drops',
        'Best experienced driving uphill (Sarchu â†’ Pang direction) for the full thrill',
        'altitude sickness can hit suddenly â€” carry Diamox and stay hydrated',
        'Night camping at Sarchu (lower altitude) recommended before crossing',
        'BRO signboards along the route are famously witty â€” enjoy them!',
      ],
    ...
    },
    {
      ...
      location: 'Between Keylong and Sarchu, Lahaulâ€“Ladakh border',
      ...
      overview:
        'Baralacha La marks the natural boundary between Lahaul (Himachal Pradesh) and Ladakh, and is the source of both the Bhaga and Yunam rivers. The pass sits at the junction of three mountain ranges â€” the Pir Panjal, the Great Himalayan Range, and the Zanskar Range â€” making it a geographical marvel. Near the summit lies the pristine Suraj Tal (Sun Lake), one of the highest lakes in India at 16,040 ft, with impossibly blue waters surrounded by snow-covered peaks. The pass is often the first major altitude challenge for travelers on the Manaliâ€“Leh route after crossing the atal Tunnel and Keylong.',
      history:
        'Baralacha La has been an important trade crossing for over a thousand years, connecting the Chandra valley of Lahaul with the markets of Ladakh and Central asia. ancient trade caravans carrying wool, salt, spices, and precious stones crossed this pass regularly. The name "Baralacha" is believed to derive from the Tibetan word for a crossroads, reflecting its position at the meeting point of three valleys. During the British Raj, the pass was surveyed and documented as part of the Great Trigonometric Survey of India. Today it remains a critical point on the Manaliâ€“Leh Highway, and the Suraj Tal nearby has become a popular photography destination.',
      highlights: [
        ...
        { label: 'River Source', detail: 'Source of both the Bhaga and Yunam rivers â€” a hydrological wonder' },
      ...
      videoDesc: 'Cross the ancient three-range junction and discover the pristine Suraj Tal â€” one of India\'s highest lakes.',
      tips: [
        'Stop at Suraj Tal for photos â€” it\'s right beside the road',
        'Keylong (last town with amenities) is the best place to refuel and rest before the pass',
        'Snow can block the road well into June â€” check BRO opening status',
        'Water crossings (nala crossings) common near the pass â€” high-clearance vehicle recommended',
    ...
    },
    {
      ...
      highlights: [
        { label: 'Road Less Traveled', detail: 'Only a handful of vehicles per day â€” total solitude guaranteed' },
      ...
      gallery: [
        { title: 'Remote Summit', image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=800', desc: 'The solitary Wari La summit â€” no cafes, no crowds, just mountains' },
      ...
      image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=600',
      heroImage: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=1600',
      videoTitle: 'Wari La â€” The Road Less Traveled',
      videoDesc: 'an off-road adventure over Ladakh\'s most solitary high pass â€” the alternative route to Nubra Valley.',
      tips: [
        'Suitable only for experienced drivers â€” 4WD or high-clearance bikes recommended',
        'No amenities or fuel for the entire stretch â€” carry everything you need',
        'Road may be closed earlier than Khardung La â€” check locally before attempting',
        'Best done Leh â†’ Nubra (uphill is safer than downhill on loose gravel)',
        'Inform someone of your travel plans â€” mobile coverage is non-existent',
      ],
    ...
    },
    {
      ...
      road: 'Srinagarâ€“Leh Highway',
      status: 'Motorable (Mayâ€“Nov)',
      gradient: 'linear-gradient(135deg, #1e40af, #3b82f6)',
      location: 'Between Lamayuru and Khalsi, Srinagarâ€“Leh Highway',
      coordinates: '34.2528Âa N, 76.5850Âa E',
      lat: 34.2528, lng: 76.5850, zoom: 13,
      openSeason: 'May â€“ November',
      distance: '145 km from Leh',
      desc: 'Highest point on the Srinagarâ€“Leh Highway, near the famous Lamayuru Monastery.',
      overview:
        'Fotu La is the highest point on the Srinagarâ€“Leh Highway (NH 1), the historic National Highway connecting Kashmir to Ladakh. Unlike the extreme-altitude passes on the Manaliâ€“Leh route, Fotu La is a more gentle crossing that is accessible to ordinary vehicles. The pass sits between the Wakha Valley and the Lamayuru moonscape region, offering views of rocky, arid mountains on both sides. Just a short detour from the pass leads to the extraordinary Lamayuru Monastery, one of the oldest and most dramatically situated monasteries in Ladakh, perched on surreal eroded clay formations.',
      history:
        'The Srinagarâ€“Leh Highway, passing through Fotu La, is the older and historically more important of the two highway approaches to Ladakh. This route has been used for over a thousand years as part of the ancient trade network connecting Kashmir to Central asia via Ladakh. The modern highway was built in the mid-20th century and became India\'s primary supply route to Ladakh. During the 1999 Kargil War, this highway was the lifeline for the Indian military, with convoys passing over Fotu La daily. The road is now being significantly upgraded with tunnels planned at Zoji La and other points to make it an all-weather route.',
      highlights: [
        ...
        { label: 'Gentle Crossing', detail: 'accessible to ordinary vehicles â€” no extreme altitude challenges' },
        { label: 'Kargil War Route', detail: 'Critical military supply route during the 1999 Kargil conflict' },
      ],
      gallery: [
        { title: 'Highway Summit', image: 'https://images.unsplash.com/photo-1590059530472-7634f596ee24?auto=format&fit=crop&q=80&w=800', desc: 'The Fotu La summit on the Srinagarâ€“Leh Highway with signboard' },
      ...
      image: 'https://images.unsplash.com/photo-1590059530472-7634f596ee24?auto=format&fit=crop&q=80&w=600',
      heroImage: 'https://images.unsplash.com/photo-1590059530472-7634f596ee24?auto=format&fit=crop&q=80&w=1600',
      videoTitle: 'Fotu La â€” The Historic Crossing',
      videoDesc: 'Cross the highest point on the Srinagarâ€“Leh Highway and descend into the Lamayuru moonscape.',
      tips: [
        'Much more accessible than Manaliâ€“Leh passes â€” suitable for all vehicles',
        'Combine with a stop at Lamayuru Monastery (10 minutes detour)',
        'Tea stalls available at the summit in peak season',
        'The Srinagarâ€“Leh route is a 2-day journey â€” halt at Kargil or Mulbekh',
        'Open much longer (Mayâ€“Nov) than the Manaliâ€“Leh passes',
      ],
    ...
    },
    {
      ...
      overview:
        'Zoji La is the first â€” and most dramatic â€” pass that travelers encounter on the Srinagarâ€“Leh Highway. Though comparatively low in altitude at 11,578 ft, Zoji La is considered one of the most dangerous mountain passes in India due to its extreme weather, narrow road, steep drops, and avalanche-prone terrain. The pass marks the geographical boundary between the lush green Kashmir Valley and the arid, stark landscape of Ladakh. On one side lies the flower-filled meadows of Sonamarg ("Meadow of Gold"), and on the other, the bleak terrain of Drass â€” the second coldest inhabited place on Earth. The under-construction Zoji La tunnel (14.15 km), when completed, will provide all-weather connectivity to Ladakh for the first time in history.',
      history:
        'Zoji La has been the primary gateway to Ladakh from Kashmir for over a millennium, crossed by armies, traders, missionaries, and pilgrims throughout history. During the First Kashmir War (1947â€“48), the Battle of Zoji La was one of the most critical engagements â€” Indian forces used tanks at this altitude for the first time in military history to recapture the pass from Pakistani forces, securing Ladakh for India. The Zoji La tunnel project, approved in 2018 and expected to be asia\'s longest bi-directional tunnel, will transform Ladakh\'s connectivity by eliminating the annual 6-month road closure. The tunnel is being built at an estimated cost of â‚¹6,800 crore.',
      highlights: [
        { label: 'Gateway to Ladakh', detail: 'The first pass on the Srinagar route â€” the threshold between Kashmir and Ladakh' },
        { label: '1947 Battle Site', detail: 'Historic site of the Battle of Zoji La â€” tanks used at altitude for the first time' },
        { label: 'Zoji La Tunnel', detail: 'asia\'s longest bi-directional tunnel (14.15 km) under construction â€” all-weather access' },
        { label: 'Climate Boundary', detail: 'The dividing line between green Kashmir and arid Ladakh â€” visible in real time' },
      ],
      gallery: [
        ...
        { title: 'Drass Valley', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', desc: 'The stark landscape of Drass â€” second coldest inhabited place on Earth â€” beyond the pass' },
      ],
      ...
      videoTitle: 'Zoji La â€” The Gateway Pass',
      videoDesc: 'Cross the legendary gateway from green Kashmir to arid Ladakh â€” and see the tunnel that will change everything.',
      tips: [
        'The road is narrow with sheer drops â€” experienced drivers only during bad weather',
        'Check BRO road status before starting â€” the pass closes frequently for maintenance',
        'Sonamarg is the best base camp on the Kashmir side â€” beautiful meadows and hotels',
        'Traffic runs one-way during peak hours â€” know the schedule before starting',
        'Winter closure typically Novemberâ€“May, but varies â€” check with BRO',
      ],
