...
export class RoadTripDetail {
  ...
  constructor() {
    ...
    if (found) {
      ...
      const title = `${found.name} Road Trip — ${found.distance}, ${found.duration} | The Ladakh archive`;
  ...
  trips: RoadTripData[] = [
    /* â”€â”€ 1. Leh â†’ Nubra Valley â”€â”€ */
    {
      ...
      longDescription: 'The Leh to Nubra Valley road trip is every traveler\'s first Ladakh Adventure beyond Leh. The journey takes you over Khardung La — one of the highest motorable passes in the world at 18,380 ft. as you descend into the Nubra Valley, the landscape transforms from barren high-altitude desert into A surprisingly green oasis. The Shyok and Nubra rivers carve through deep gorges, and at Hunder, you\'ll find surreal white sand dunes where Bactrian (double-humped) camels roam. The drive continues to Diskit, home to A stunning 32-metre Maitreya Buddha statue, and further to Turtuk — the last Indian village before Pakistan, A Balti settlement opened to tourists only in 2010.',
      keyStops: ['Khardung La', 'South Pullu', 'North Pullu', 'Khalsar', 'Diskit Monastery', 'Hunder Sand Dunes', 'Turtuk Village'],
      photos: [
        { title: 'Khardung La Pass', image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=800', icon: 'bi-flag', location: 'Khardung La, 18,380 ft', desc: 'The gateway to Nubra Valley — prayer flags flutter against an impossibly blue sky at the summit.' },
        { title: 'Hunder Sand Dunes', image: 'https://images.unsplash.com/photo-1590059530472-7634f596ee24?auto=format&fit=crop&q=80&w=800', icon: 'bi-sun', location: 'Hunder, Nubra Valley', desc: 'White sand dunes flanked by snow-capped mountains — A surreal desert at 10,000 ft altitude.' },
        ...
        { title: 'Turtuk Village', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-house', location: 'Turtuk, Nubra Valley', desc: 'India\'s last village before Pakistan — A Balti settlement with apricot orchards and traditional homes.' },
      ],
      ...
      videos: [
        { title: 'Leh to Nubra Valley — Complete Road Trip', youtubeId: 'KRF7jWqSdPw', duration: '18 min', desc: 'Experience the complete journey from Leh over Khardung La to Nubra Valley with stunning aerial footage.', gradient: 'linear-gradient(135deg, #064e3b, #10b981)', icon: 'bi-camera-reels' },
        { title: 'Turtuk — India\'s Last Village', youtubeId: 'zNFmzjxQGHk', duration: '12 min', desc: 'Explore the hidden Balti village of Turtuk near the Line of Control.', gradient: 'linear-gradient(135deg, #1a365d, #3b82f6)', icon: 'bi-film' },
      ],
      itinerary: [
        { day: 'Day 1', title: 'Leh â†’ Diskit via Khardung La', desc: 'Start early from Leh. Climb to Khardung La (18,380 ft) — stop for photos at the summit. Descend through South & North Pullu checkpoints. Reach Khalsar junction, turn towards Diskit. Visit Diskit Monastery and the giant Maitreya Buddha statue. Overnight at Diskit.', stops: ['Khardung La', 'South Pullu', 'North Pullu', 'Khalsar', 'Diskit'], distance: '120 km', altitude: '18,380 ft max' },
        { day: 'Day 2', title: 'Diskit â†’ Hunder â†’ Turtuk', desc: 'Morning visit to Hunder Sand Dunes and Bactrian camel rides. Drive further to Turtuk (80 km from Diskit) — India\'s last village. Explore Balti heritage, the 500-year-old Turtuk royal house, and apricot orchards. Return to Hunder for the night.', stops: ['Hunder Sand Dunes', 'Turtuk Village', 'Turtuk Royal House'], distance: '160 km round trip', altitude: '10,000 ft' },
      ...
      tips: [
        ...
        'Carry warm clothes — temperature drops drastically at the pass even in summer',
        'Fill fuel in Leh — Diskit has the only fuel station in Nubra',
        'Carry aMS medication (Diamox) and acclimatize in Leh for 2 days before this trip',
        'Photography at North Pullu and beyond needs caution — military zones',
        'Book Turtuk homestays in advance during peak season (Jul–aug)',
      ],
    ...
    /* â”€â”€ 2. Leh â†’ Pangong Tso â”€â”€ */
    {
      ...
      longDescription: 'The road to Pangong Tso is one of the most celebrated journeys in Ladakh. The route crosses Chang La (17,688 ft) — the third highest motorable pass in India — before descending through the stark Changthang Plateau to arrive at the incomparable Pangong Lake. The lake stretches 134 km, with two-thirds lying in Tibet. Its unique feature is the constantly shifting palette of blues — from azure to turquoise to deep indigo — caused by the varying light, depth, and mineral content. The lake gained worldwide fame after the Bollywood film "3 Idiots" shot its climactic scene here. The sheer vastness, silence, and impossibly vivid colors make this one of the most photographed locations in the Himalayas.',
      keyStops: ['Karu', 'Chang La', 'Tangste', 'Lukung', 'Spangmik', 'Pangong Lake', 'Man–Merak'],
      photos: [
        { title: 'Chang La Pass', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-flag', location: 'Chang La, 17,688 ft', desc: 'The gateway to Pangong — army-maintained pass with A small temple and tea stall at the summit.' },
        { title: 'Pangong Lake — Blue Hour', image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=800', icon: 'bi-water', location: 'Spangmik, Pangong Tso', desc: 'The legendary blue waters of Pangong stretching endlessly toward Tibet under A cloudless sky.' },
        { title: 'Pangong — Turquoise Waters', image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=800', icon: 'bi-droplet', location: 'Pangong Tso', desc: 'The lake shifts from deep blue to turquoise to emerald depending on light and depth.' },
        ...
        { title: '3 Idiots Point', image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=800', icon: 'bi-film', location: 'Pangong Tso', desc: 'The famous yellow scooter and bench from the Bollywood blockbuster — now A tourist photo spot.' },
      ],
      image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=600',
      heroImage: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=1600',
      videos: [
        { title: 'Pangong Lake — A Visual Journey', youtubeId: '5PEbw7r3mYE', duration: '15 min', desc: 'Stunning 4K aerial and ground footage of Pangong Tso through all seasons and times of day.', gradient: 'linear-gradient(135deg, #0c4a6e, #0ea5e9)', icon: 'bi-camera-reels' },
      ],
      itinerary: [
        { day: 'Day 1', title: 'Leh â†’ Pangong Tso via Chang La', desc: 'Depart Leh early. Pass through Karu and begin the ascent to Chang La (17,688 ft). Stop at the army-run cafeteria for tea. Descend through Tangste — last settlement with phone signal. arrive at Pangong Lake by afternoon. Watch the magical color changes of the water. Overnight in lakeside camps at Spangmik.', stops: ['Karu', 'Chang La', 'Tangste', 'Lukung', 'Spangmik'], distance: '160 km', altitude: '17,688 ft max' },
        { day: 'Day 2', title: 'Pangong â†’ Man–Merak â†’ Leh', desc: 'Sunrise at Pangong is unmissable. Explore towards Man and Merak villages (Changpa nomad settlements). Return via the same route over Chang La to Leh.', stops: ['Pangong Sunrise Point', 'Man Village', 'Merak', 'Chang La', 'Leh'], distance: '170 km', altitude: '17,688 ft max' },
      ],
      elevation: [
        { name: 'Leh', altitude: 11500, km: 0 },
      ...
      tips: [
        'There is absolutely ZERO mobile network at Pangong — inform family before leaving Tangste',
        'Temperatures drop to -5ÂaC at night even in July — carry heavy sleeping bag',
        'Fill fuel in Karu — no fuel station until Pangong and back',
        'Lakeside camps can be basic — carry your own toiletries and toilet paper',
        'Do NOT swim in the lake — the water is extremely cold and the lake is militarily sensitive',
        'Dawn light (5:30–6:30 aM) produces the best photographs',
      ],
      packing: ['Heavy sleeping bag', 'Down jacket', 'Sunscreen SPF 50+', 'UV sunglasses', 'Camera with extra batteries (cold drains them)', 'Cash — no aTMs or card machines', 'Printed ILP copies', 'Personal water filter/bottles'],
      accommodation: [
        { name: 'Pangong Retreat Camp', type: 'Luxury Camp', location: 'Spangmik' },
        { name: 'The Pangong Camp', type: 'Deluxe Camp', location: 'Spangmik' },
        { name: 'Lakeside Camps', type: 'Basic Tent', location: 'Spangmik – Lukung' },
      ],
    ...
    /* â”€â”€ 3. Leh â†’ Tso Moriri â”€â”€ */
    {
      ...
      longDescription: 'Tso Moriri is Ladakh\'s hidden gem — far less visited than Pangong but equally magnificent. This is one of the highest lakes in India and A designated Ramsar Wetland of international importance. The lake sits in the Changthang Cold Desert Wildlife Sanctuary, surrounded by 6,000-metre peaks. Unlike commercialized Pangong, Tso Moriri offers solitude and raw wilderness. The only settlement is Korzok village, home to Changpa nomads who herd pashmina goats at altitudes above 14,000 ft. En route, you pass Puga Valley\'s geothermal hot springs — steam vents and sulphur deposits that hint at the volcanic activity beneath the plateau. The route is rough and remote — A true Adventure for those seeking undiscovered Ladakh.',
      ...
      photos: [
        ...
        { title: 'Puga Hot Springs', image: 'https://images.unsplash.com/photo-1590059530472-7634f596ee24?auto=format&fit=crop&q=80&w=800', icon: 'bi-thermometer-half', location: 'Puga Valley', desc: 'Bubbling geothermal vents and sulphur deposits — evidence of volcanic activity beneath the plateau.' },
        ...
        { title: 'Korzok Monastery', image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=800', icon: 'bi-building', location: 'Korzok Village', desc: 'The Drukpa Kagyu monastery overlooking the lake — one of the highest permanently inhabited settlements in India.' },
      ...
      videos: [
        { title: 'Tso Moriri — Ladakh\'s Hidden Paradise', youtubeId: 'QJuvqMfXLqs', duration: '20 min', desc: ' A cinematic journey to the pristine Tso Moriri lake and the nomadic Changpa way of life.', gradient: 'linear-gradient(135deg, #2e1065, #a78bfa)', icon: 'bi-camera-reels' },
      ],
      itinerary: [
        { day: 'Day 1', title: 'Leh â†’ Puga â†’ Korzok', desc: 'Depart Leh via Upshi on the Manali–Leh Highway. Turn south at Upshi towards Chumur. Pass through the stark Changthang plateau. Stop at Puga Hot Springs to see geothermal vents. Continue to Sumdo checkpoint and then to Korzok village on the shores of Tso Moriri. arrive by evening.', stops: ['Upshi', 'Chumur', 'Puga Hot Springs', 'Sumdo', 'Korzok'], distance: '240 km', altitude: '14,836 ft' },
        { day: 'Day 2', title: 'Korzok — Exploration Day', desc: 'Sunrise at the lake is transcendent. Walk along the lakeside trail (5 km). Visit Korzok Monastery. Interact with Changpa nomads and see pashmina goat herds. Look for kiang (wild ass) and marmots. afternoon photography session as light changes.', stops: ['Tso Moriri Lakeside Walk', 'Korzok Monastery', 'Changpa Camp'], distance: '10 km walk', altitude: '14,836 ft' },
        { day: 'Day 3', title: 'Korzok â†’ Tso Kar â†’ Leh', desc: 'Return via Alternative route through Tso Kar (White Lake) — A smaller salt lake with flamingo sightings. Pass Tanglang La (17,582 ft) and rejoin the Manali–Leh Highway. arrive in Leh by evening.', stops: ['Tso Kar Lake', 'Pang', 'Tanglang La', 'Upshi', 'Leh'], distance: '280 km', altitude: '17,582 ft max' },
      ],
      elevation: [
        { name: 'Leh', altitude: 11500, km: 0 },
      ...
      tips: [
        'This is one of the remotest routes — NO fuel, mobile signal, or medical facilities after Upshi',
        'Carry at least 20L extra fuel in jerry cans',
        'Road conditions are poor — A sturdy SUV (ideally 4Ã—4) is recommended',
        'acclimatize in Leh for 3 days minimum before this trip',
        'Korzok has very basic homestays — carry your own sleeping bag and food',
        'Wildlife is best spotted early morning — kiang herds are often near the lake',
      ],
      packing: ['Extra fuel (20L jerry can)', 'Food supplies for 3 days', 'Sleeping bag rated to -10ÂaC', 'First-aid & aMS medicine', 'Warm layers — it can snow any month', 'Binoculars for wildlife', 'Cash — zero connectivity beyond Upshi', 'Spare tyre & basic tools'],
      accommodation: [
    ...
    /* â”€â”€ 4. Leh â†’ Hanle â”€â”€ */
    {
      ...
      longDescription: 'Hanle is the frontier of Astronomy in India. The Indian astronomical Observatory (IaO), operated by the Indian Institute of astrophysics, sits at 14,764 ft — one of the highest optical telescopes on the planet. The region boasts over 270 clear nights per year with near-zero light pollution, making it one of the best spots on Earth for stargazing. But Hanle is far more than an observatory — the Ancient Hanle Monastery (17th century) sits dramatically atop A hill overlooking the vast Hanle plain. The landscape is Mars-like: utterly barren, rust-colored, and silent. The drive itself passes through some of Ladakh\'s most desolate and beautiful terrain, crossing high passes and sweeping valleys that feel like another planet.',
      keyStops: ['Upshi', 'Loma', 'Nyoma', 'Hanle Monastery', 'Indian astronomical Observatory'],
      photos: [
        { title: 'Night Sky at Hanle', image: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&q=80&w=800', icon: 'bi-stars', location: 'Hanle, 14,764 ft', desc: 'The Milky Way in all its glory — visible to the naked eye from one of Earth\'s best stargazing sites.' },
        { title: 'Indian astronomical Observatory', image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&q=80&w=800', icon: 'bi-telescope', location: 'Hanle Observatory', desc: 'One of the world\'s highest optical telescopes — cutting-edge science at the roof of the world.' },
        ...
        { title: 'Mars-like Landscape', image: 'https://images.unsplash.com/photo-1590059530472-7634f596ee24?auto=format&fit=crop&q=80&w=800', icon: 'bi-globe', location: 'Hanle Plain', desc: 'The rust-red barren terrain around Hanle looks like the surface of Mars — utterly otherworldly.' },
        { title: 'Nyoma Bridge & Valley', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-water', location: 'Nyoma', desc: 'The Indus River at Nyoma — the last real settlement before the vast emptiness leading to Hanle.' },
      ],
      ...
      videos: [
        { title: 'Hanle — India\'s Dark Sky Sanctuary', youtubeId: 'KRF7jWqSdPw', duration: '22 min', desc: 'Explore Hanle\'s observatory, Ancient monastery, and the darkest skies in India.', gradient: 'linear-gradient(135deg, #0f172a, #6366f1)', icon: 'bi-camera-reels' },
      ],
      itinerary: [
        { day: 'Day 1', title: 'Leh â†’ Nyoma â†’ Hanle', desc: 'Depart Leh early via Upshi. Follow the Indus Valley through Loma and Nyoma. Turn south towards Hanle after Nyoma. The road becomes increasingly remote. arrive at Hanle by late afternoon. Visit Hanle Monastery before sunset. Night: stargazing — the Milky Way is visible to the naked eye.', stops: ['Upshi', 'Loma', 'Nyoma', 'Hanle Monastery'], distance: '260 km', altitude: '14,764 ft' },
        { day: 'Day 2', title: 'Hanle â†’ Observatory â†’ Leh', desc: 'Morning visit to the Indian astronomical Observatory (exterior only — prior permission needed for interior). Explore the Hanle plain. Return to Leh via Nyoma. Optional detour to Merak village near Pangong.', stops: ['IaO Observatory', 'Hanle Plain', 'Nyoma', 'Leh'], distance: '260 km', altitude: '14,764 ft' },
      ],
      elevation: [
        { name: 'Leh', altitude: 11500, km: 0 },
        { name: 'Upshi', altitude: 12000, km: 50 },
      ...
      tips: [
        'Hanle is A RESTRICTED area near the LaC — permit approval can take 1–2 days',
        'apply for permit at DC Office Leh well in advance',
        'NO fuel station between Karu and Hanle — carry enough fuel for 550 km round trip',
        'Best stargazing: new moon nights in July–august — plan accordingly',
        'The observatory interior requires prior written permission from IIa Bangalore',
        'Temperature drops to -15ÂaC at night even in summer — carry extreme cold gear',
      ],
    ...
    /* â”€â”€ 5. Leh â†’ Zanskar Valley â”€â”€ */
    {
      ...
      longDescription: 'Zanskar is Ladakh\'s most inaccessible sub-region — A vast, remote valley ringed by the Great Himalayan Range and reachable by road only 3-4 months per year. The journey from Leh takes you first to Kargil (the halfway city on the Srinagar–Leh Highway), then south over the Pensi La (14,001 ft) into the Suru Valley and finally into Zanskar. The valley\'s isolation has preserved A way of life unchanged for centuries — Ancient Buddhist monasteries cling to clifftops, and villagers still practice barter trade. Padum, the tiny capital, feels like stepping into medieval Tibet. From Padum, you can reach Zangla Fort, Karsha Monastery (Zanskar\'s largest), and the confluence of Zanskar and Doda rivers. The return journey over Pensi La, with its views of the Drang Drung Glacier, is equally spectacular.',
      ...
      photos: [
        ...
        { title: 'Rangdum Monastery', image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=800', icon: 'bi-building', location: 'Rangdum', desc: 'The isolated Gelugpa monastery sitting on A hillock in the vast Suru Valley — A sentinel of solitude.' },
        { title: 'Padum — Zanskar\'s Capital', image: 'https://images.unsplash.com/photo-1516233758813-a38d024919c5?auto=format&fit=crop&q=80&w=800', icon: 'bi-geo-alt', location: 'Padum', desc: 'The tiny capital of Zanskar — A cluster of whitewashed houses ringed by towering mountains.' },
        ...
        { title: 'Zanskar River Gorge', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-water', location: 'Zanskar Valley', desc: 'The turquoise Zanskar River cutting through impossibly deep gorges — the same river that freezes into the Chadar.' },
      ],
      image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=600',
      heroImage: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=1600',
      videos: [
        { title: 'Zanskar — The Forgotten Valley', youtubeId: 'zNFmzjxQGHk', duration: '28 min', desc: ' A documentary journey through Zanskar\'s Ancient monasteries, remote villages, and vanishing way of life.', gradient: 'linear-gradient(135deg, #78350f, #f97316)', icon: 'bi-camera-reels' },
        { title: 'Driving to Zanskar — The Adventure Road', youtubeId: '5PEbw7r3mYE', duration: '16 min', desc: 'Experience the thrilling drive over Pensi La and through the Suru Valley to Padum.', gradient: 'linear-gradient(135deg, #1e3a5f, #38bdf8)', icon: 'bi-film' },
      ],
      itinerary: [
        { day: 'Day 1', title: 'Leh â†’ Kargil', desc: 'Drive from Leh to Kargil on the Srinagar–Leh Highway (220 km, 6–7 hours). Stop at Lamayuru Monastery\'s moonland, alchi temple complex, and Mulbekh\'s giant Maitreya rock carving. Overnight in Kargil.', stops: ['Lamayuru', 'alchi', 'Mulbekh', 'Kargil'], distance: '220 km', altitude: '8,900 ft' },
        ...
        { day: 'Day 3', title: 'Padum — Exploration Day', desc: 'Visit Karsha Monastery (Zanskar\'s largest), Stongde Gompa, and Zangla Fort. Explore Padum market. Optional half-day trek to Phuktal Monastery (requires additional day).', stops: ['Karsha Monastery', 'Stongde Gompa', 'Zangla Fort', 'Padum Market'], distance: '40 km', altitude: '12,500 ft' },
      ...
      tips: [
        'Road to Padum is only open July–September — check condition with J&K Tourism before going',
        'Carry fuel for the entire round trip from Kargil — NO fuel in Zanskar',
        'Road conditions beyond Rangdum can be extremely poor — budget extra time for delays',
        'Kargil–Padum stretch has zero mobile signal — carry A satellite communicator',
        'If attempting Phuktal Monastery trek, add 2 extra days',
        'Carry all food supplies — Padum has very limited shops',
      ],
      packing: ['Extra fuel (30L+)', 'Food & water for 4 days', 'Tow rope & spare parts', 'Heavy sleeping bag', 'Rain gear (monsoon affects Pensi La)', 'Cash — no aTMs in Zanskar', 'First-aid kit with altitude medication', 'Sturdy walking shoes for monastery visits'],
      accommodation: [
    ...
    /* â”€â”€ 6. Changthang Circuit â”€â”€ */
    {
      ...
      photos: [
        ...
        { title: 'Chushul Valley', image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&q=80&w=800', icon: 'bi-geo-alt', location: 'Chushul', desc: 'The strategic valley near the LaC — vast, empty, and ringed by mountains touching China and India.' },
      ],
      ...
      videos: [
        { title: 'The Changthang Circuit — Ladakh\'s Ultimate Drive', youtubeId: 'QJuvqMfXLqs', duration: '35 min', desc: ' A raw, unfiltered documentary of the 350 km journey between Pangong and Tso Moriri.', gradient: 'linear-gradient(135deg, #451a03, #dc2626)', icon: 'bi-camera-reels' },
      ],
      itinerary: [
        { day: 'Day 1', title: 'Pangong â†’ Chushul â†’ Nyoma', desc: 'Depart Spangmik along the southern shore of Pangong. Pass through Man and Merak villages (Changpa settlements). Cross to Chushul — A military zone near the LaC. Visit Rezang La War Memorial. Continue to Nyoma on the Leh–Hanle road. Overnight in Nyoma.', stops: ['Spangmik', 'Man', 'Merak', 'Chushul', 'Rezang La Memorial', 'Nyoma'], distance: '180 km', altitude: '16,000 ft max' },
      ...
      elevation: [
        ...
        { name: 'Man–Merak', altitude: 14800, km: 40 },
      ...
      tips: [
        'This route is ONLY for experienced overlanders — do NOT attempt alone',
        'Minimum two vehicles recommended — there is NO breakdown assistance available',
        'Carry fuel for 400+ km, food for 3 days, and 10L extra water',
        'Special permits required for Man–Merak and Chushul areas',
        'Road conditions range from bad to non-existent — A 4Ã—4 is mandatory',
        'Zero phone signal for the entire route — carry A satellite communicator',
        'altitude stays above 13,000 ft throughout — take aMS seriously',
      ],
