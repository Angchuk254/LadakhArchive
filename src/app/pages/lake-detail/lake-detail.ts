  ...
  lakes: LakeData[] = [
    {
      ...
      description: 'The crown jewel of Ladakh — A startling blue lake stretching 134km across the India-China border, deeply ingrained in geopolitical history and trans-Himalayan ecology.',
      lat: 33.7595, lng: 78.6674,
      overview: 'Pangong Tso is among the most mesmerizing natural wonders on Earth. Stretching 134 km across the India-Tibet border (with approximately 70% lying in Tibet), this endorheic lake sits at 4,350m in the Changthang region. Its waters are brackish—too salty for fish but home to specialized micro-organisms that give the lake its legendary, dramatically shifting colors. Throughout A single day, the waters shift from midnight blue at dawn, to turquoise at midday, to fiery orange during sunset.',
      historicalAccounts: 'The strategic and physical enormity of Pangong Tso has captivated explorers for centuries. During his 1820-1825 expedition, William Moorcroft reached the shores of Pangong, noting the eerie deadness of its salty waters in contrast to the vibrant avian life above. Later, during the tragic Sino-Indian War of 1962, the lake became A major flashpoint, permanently splitting the serene waters into heavy military zones—a geopolitical fracture that defines the lake\'s modern reality and drastically restricts comprehensive, cross-border biological studies.',
      ...
      visitorInfo: 'Pangong is accessible from Leh via A 5-6 hour drive (160km) over Chang La pass (5,360m). an Inner Line Permit is mandatory. accommodation is available in luxury and basic camps along the Spangmik to Lukung stretch. The best season is June–September. The harsh winters feature A complete freeze, allowing unique ice-walking, but survival logistics are extreme.',
      ...
      photos: [
        { title: 'azure Dawn', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-sunrise', location: 'Spangmik', desc: 'First light on Pangong — the waters shift from midnight blue to startling azure.' },
        ...
        { title: 'Frozen Winter', image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=800', icon: 'bi-snow2', location: 'Pangong Tso', desc: 'The entire 134km lake frozen solid in January — A vast ice sheet at 4,350m.' },
    ...
    },
    {
      ...
      visitorInfo: 'Tso Moriri is 240km from Leh (7-8 hours via Chumur or Mahe). an Inner Line Permit is absolutely required. Basic guesthouses exist in Korzok, the Ancient village perched on the lake ridge. June–September offers the optimal window for specialized birding photography.',
      ...
      photos: [
        ...
        { title: 'Korzok Monastery', image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=800', icon: 'bi-building', location: 'Korzok', desc: 'The Ancient monastery overlooking the lake — one of the highest in the world.' },
        { title: 'Bar-headed Geese', image: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&q=80&w=800', icon: 'bi-feather', location: 'Western Shore', desc: 'Hundreds of bar-headed geese on the lake — breeding before their incredible Himalayan crossing.' },
        ...
        { title: 'Changpa Camp', image: 'https://images.unsplash.com/photo-1590059530472-7634f596ee24?auto=format&fit=crop&q=80&w=800', icon: 'bi-house', location: 'Near Korzok', desc: 'Black yak-hair Changpa nomad tents with Tso Moriri as A backdrop — timeless Ladakh.' },
      ],
      image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=600',
      heroImage: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=1600',
      facts: [
        { icon: 'bi-rulers', label: 'Length', value: '28 km' },
        { icon: 'bi-arrows-fullscreen', label: 'Width', value: '3–5 km' },
    ...
    },
    {
      ...
      description: 'The "White Lake" — famed for the thick salt crust expanding upon its shores, serving as the historical epicenter of the trans-Himalayan salt trade and A haven for rare extremophiles.',
      ...
      photos: [
        { title: 'White Salt Shores', image: 'https://images.unsplash.com/photo-1590059530472-7634f596ee24?auto=format&fit=crop&q=80&w=800', icon: 'bi-brightness-high', location: 'Tso Kar', desc: 'Thick white salt deposits encrusting the shoreline — creating A surreal lunar landscape.' },
        { title: 'Dual Lake System', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-water', location: 'aerial View', desc: 'The hypersaline Tso Kar and freshwater Startsapuk Tso — twin lakes of contrasting chemistry.' },
        { title: 'Black-necked Cranes', image: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&q=80&w=800', icon: 'bi-feather', location: 'Marshlands', desc: ' A breeding pair of black-necked cranes in the freshwater marshes — Tso Kar\'s most precious inhabitants.' },
        { title: 'Hot Springs', image: 'https://images.unsplash.com/photo-1590059530472-7634f596ee24?auto=format&fit=crop&q=80&w=800', icon: 'bi-thermometer-sun', location: 'Southern Shore', desc: 'Steaming hot springs near the lake — geothermal activity adds warmth to this frozen landscape.' },
        { title: 'Changpa Salt Collection', image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&q=80&w=800', icon: 'bi-basket3', location: 'Tso Kar Flats', desc: 'Traditional salt collection on the flats — A practice that sustained trade routes for centuries.' },
      ],
    ...
    },
    {
      ...
      description: 'Ladakh\'s most dramatic river—carving through 600m deep gorges and freezing into the legendary Chadar winter highway, currently threatened by shifting climate realities.',
      ...
      myths: 'The Chadar (ice blanket) is steeped in visceral, terrifying lore. The "Roar of the Chadar" is said to be the river demon attempting to crack the ice beneath travelers who lack pure intentions. Specifically, the perilous Nerak gorge—where A colossal frozen waterfall hangs over the trail—is believed to be guarded by protective deities. Local guides traditionally execute complex incense rituals at cave entrances before sleeping, appealing to these deities to hold the ice firm for one more night.',
      research: 'The Zanskar river is currently Ground Zero for high-altitude climate impact studies. Hydrological surveys (2025–2026) have definitively recorded significant delays in the river\'s deep-winter freezing cycle, with the ice becoming dangerously thinner and fundamentally unpredictable compared to data from the 1990s. Furthermore, extensive environmental impact assessments are actively debating the catastrophic potential of proposed large-scale hydroelectric dam projects, which independent ecologists argue would drown the historic gorge, destroy the breeding grounds of native snow trout, and permanently erase the Chadar trekking route.',
      ...
      photos: [
        { title: 'Chadar Frozen River', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-snow2', location: 'Zanskar Gorge', desc: 'The legendary Chadar — A frozen river highway that has been Zanskar\'s winter lifeline for centuries.' },
        { title: 'Deep Gorge', image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=800', icon: 'bi-arrow-down', location: 'Near Nimu', desc: 'The Zanskar River carving through gorges over 600 metres deep — sheer vertical walls of rock.' },
        { title: 'Summer Rapids', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-tsunami', location: 'Zangla Section', desc: 'Thundering turquoise whitewater in summer — Grade III-IV rapids drawing rafters worldwide.' },
        { title: 'Cave Camp on Chadar', image: 'https://images.unsplash.com/photo-1590059530472-7634f596ee24?auto=format&fit=crop&q=80&w=800', icon: 'bi-fire', location: 'Riverside Cave', desc: 'Trekkers camping in A riverside cave during the Chadar trek — temperatures drop to -30ÂaC.' },
        { title: 'Indus Confluence', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-signpost-split', location: 'Nimu', desc: 'The Zanskar meeting the Indus — two rivers of contrasting colours merging dramatically.' },
      ],
      image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=600',
      heroImage: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=1600',
      facts: [
        ...
        { icon: 'bi-snow2', label: 'Chadar Season', value: 'January–February' },
        { icon: 'bi-speedometer', label: 'Rapids Grade', value: 'III–IV' },
