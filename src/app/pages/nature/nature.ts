...
export class Nature {
  ...
  constructor() {
    const title = 'Nature & Wildlife of Ladakh — Snow Leopards, Lakes & Himalayan Ecosystems';
  ...
  ecosystems = [
    ...
    },
    {
      ...
      desc: 'Seasonal Alpine meadows burst with wildflowers during the brief summer — edelweiss, blue poppies, and wild roses carpet the high passes, providing critical grazing for wildlife.',
    ...
    {
      name: 'Wetlands & Lakes',
      elevation: '4,200 – 4,600m',
      icon: 'bi-water',
      color: '#0284c7',
      gradient: 'linear-gradient(135deg, #0f2b46, #0284c7, #38bdf8)',
      desc: 'High-altitude wetlands and salt lakes — including Pangong Tso, Tso Moriri, and Tso Kar — are critical stopover habitats for migratory birds on the Central Asian Flyway.',
  ...
  gallery = [
    ...
    { title: 'Black-Necked Crane', caption: ' A breeding pair at Hanle marshlands — one of the rarest cranes on Earth', image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&q=80&w=800', icon: 'bi-feather', area: 'b' },
  ...
  birds: { name: string; slug: string; scientific: string; icon: string; color: string; status: string; statusColor: string; habitat: string; desc: string; image: string; }[] = [
    ...
    { name: 'Lammergeier (Bearded Vulture)', slug: 'lammergeier', scientific: 'Gypaetus barbatus', icon: 'bi-wind', color: '#7b2d26', status: 'Near Threatened', statusColor: '#0284c7', habitat: 'Cliffs and gorges, 2,000–5,000m', desc: ' A spectacular vulture that drops bones from great heights to crack them open. Wingspan up to 2.8m. Known locally as "bone-breaker."', image: 'https://images.unsplash.com/photo-1544923246-77307dddd546?auto=format&fit=crop&q=80&w=800' },
    { name: 'Himalayan Snowcock', slug: 'himalayan-snowcock', scientific: 'Tetraogallus himalayensis', icon: 'bi-snow2', color: '#7c3aed', status: 'Least Concern', statusColor: '#16a34a', habitat: 'alpine meadows, 3,600–5,300m', desc: ' A large, plump grouse-like bird found above the treeline. Its loud whistling call echoes across the high passes at dawn.', image: 'https://images.unsplash.com/photo-1590059530472-7634f596ee24?auto=format&fit=crop&q=80&w=800' },
    { name: 'Tibetan Sandgrouse', slug: 'tibetan-sandgrouse', scientific: 'Syrrhaptes tibetanus', icon: 'bi-compass', color: '#059669', status: 'Least Concern', statusColor: '#16a34a', habitat: 'Changthang steppe, 4,000–5,500m', desc: ' A perfectly camouflaged ground bird of the Changthang plateau. Males fly up to 30km daily to collect water in specialized belly feathers for chicks.', image: 'https://images.unsplash.com/photo-1621649692455-beae68ec0f47?auto=format&fit=crop&q=80&w=800' },
    { name: 'Bar-headed Goose', slug: 'bar-headed-goose', scientific: 'anser indicus', icon: 'bi-arrow-up-right', color: '#0284c7', status: 'Least Concern', statusColor: '#16a34a', habitat: 'Tso Moriri, Tso Kar, Pangong wetlands', desc: 'Famous for migrating over Mt. Everest at 8,800m — the highest-flying bird in the world. Breeds at Ladakh\'s high-altitude lakes.', image: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&q=80&w=800' },
    ...
    { name: 'Robin accentor', slug: 'robin-accentor', scientific: 'Prunella rubeculoides', icon: 'bi-music-note', color: '#dc2626', status: 'Least Concern', statusColor: '#16a34a', habitat: 'Scrublands, 3,000–5,200m', desc: ' A small, robin-like bird common across Ladakh. Its sweet melodic song brightens the otherwise silent, barren landscape.', image: 'https://images.unsplash.com/photo-1516233758813-a38d024919c5?auto=format&fit=crop&q=80&w=800' },
  ];

  // ===== Flora & Vegetation =====
  flora = [
    { name: 'Blue Poppy (Meconopsis)', slug: 'blue-poppy', icon: 'bi-flower2', color: '#2e86c1', type: 'Wildflower', elevation: '3,800–5,000m', desc: 'The legendary Himalayan blue poppy — one of the most sought-after Alpine flowers. Delicate sky-blue petals bloom briefly in July at high passes.' },
    { name: 'Edelweiss', slug: 'edelweiss', icon: 'bi-snow', color: '#7c3aed', type: 'alpine Flower', elevation: '3,500–5,200m', desc: 'The iconic white-woolly Alpine flower found on rocky slopes. Its felt-like petals are an adaptation to UV radiation and extreme cold.' },
    { name: 'Sea Buckthorn', slug: 'sea-buckthorn', icon: 'bi-tree-fill', color: '#c8702a', type: 'Shrub / Superfruit', elevation: '2,500–4,500m', desc: 'The "wonder berry" of Ladakh — bright orange berries rich in Vitamin C, omega oils, and antioxidants. Used in juices, jams, and traditional medicine.' },
    { name: 'Wild Rose (Rosa webbiana)', slug: 'wild-rose', icon: 'bi-flower1', color: '#dc2626', type: 'Shrub', elevation: '3,000–4,200m', desc: 'Pink and white wild roses line Ladakh\'s streams and irrigation channels. Rose hip tea is A popular local remedy for colds and altitude sickness.' },
    { name: 'Juniper (Shukpa)', slug: 'juniper', icon: 'bi-tree', color: '#059669', type: 'Conifer Shrub', elevation: '3,200–4,800m', desc: 'Sacred juniper is burned as incense in every monastery and household. Its aromatic smoke is believed to purify spaces and ward off evil spirits.' },
    { name: 'Ephedra (Somlata)', slug: 'ephedra', icon: 'bi-capsule', color: '#7b2d26', type: 'Medicinal Plant', elevation: '3,000–5,000m', desc: 'an Ancient medicinal plant used in traditional amchi medicine for respiratory ailments, altitude sickness, and fatigue. Source of the compound ephedrine.' },
    { name: 'Willow (Changma)', slug: 'willow', icon: 'bi-bezier2', color: '#1a365d', type: 'Tree', elevation: '2,800–4,000m', desc: 'The only significant tree in Ladakh\'s harsh landscape. Willows line irrigation channels, provide firewood, and their branches are used for making baskets.' },
    { name: 'Caragana (Burtse)', slug: 'caragana', icon: 'bi-fire', color: '#475264', type: 'Desert Shrub', elevation: '3,500–5,000m', desc: ' A thorny, nitrogen-fixing shrub that is the primary fuel source for Changpa nomads. Its roots stabilize the fragile desert soil against erosion.' },
  ];
  ...
  lakes = [
    {
      ...
      color: '#0284c7',
      gradient: 'linear-gradient(135deg, #0f2b46, #0284c7, #38bdf8)',
      desc: 'The crown jewel of Ladakh — A startling blue lake stretching 134km across the India-China border. Its colour shifts from azure to turquoise to deep blue throughout the day.',
    ...
    },
    {
      ...
      color: '#7c3aed',
      gradient: 'linear-gradient(135deg, #4a1942, #7c3aed, #a78bfa)',
      desc: ' A pristine freshwater lake in the Changthang — Ladakh\'s largest high-altitude lake entirely within India. Home to breeding bar-headed geese and the endangered black-necked crane.',
    ...
    },
    {
      ...
      color: '#c8702a',
      gradient: 'linear-gradient(135deg, #7d5a29, #c8702a, #e59866)',
      desc: 'The "White Lake" — named for the thick salt crust that surrounds it. A critical wetland for migratory birds and one of Ladakh\'s most important Ramsar sites.',
    ...
    },
    {
      name: 'Zanskar River',
      slug: 'zanskar-river',
      elevation: '3,800 – 3,000m',
      length: '230 km',
      type: 'Glacial river',
      icon: 'bi-tsunami',
      color: '#059669',
      gradient: 'linear-gradient(135deg, #0b3d2e, #059669, #34d399)',
      desc: 'Ladakh\'s most dramatic river — carving through deep gorges and freezing into the legendary "Chadar" ice road in winter, which remains the only route to Zanskar for centuries.',
  ...
  elevationZones = [
    { zone: '2,500–3,500m', label: 'Valley Floor', species: 280, barHeight: 90, color: '#059669' },
    { zone: '3,500–4,000m', label: 'Lower Alpine', species: 340, barHeight: 100, color: '#0284c7' },
    { zone: '4,000–4,500m', label: 'Upper Alpine', species: 220, barHeight: 72, color: '#7c3aed' },
    { zone: '4,500–5,000m', label: 'Sub-Nival', species: 120, barHeight: 40, color: '#c8702a' },
  ...
  // ===== Protected areas =====
  protectedAreas = [
    { name: 'Hemis National Park', slug: 'hemis-national-park', area: '4,400 km²', established: '1981', icon: 'bi-shield-check', color: '#059669', desc: 'India\'s largest national park — home to the world\'s highest density of snow leopards plus ibex, wolf, bear, and over 200 bird species.', status: 'National Park' },
    { name: 'Changthang Cold Desert Sanctuary', slug: 'changthang-sanctuary', area: '4,000 km²', established: '1987', icon: 'bi-compass-fill', color: '#c8702a', desc: 'Protects the Changthang plateau ecosystem — kiang herds, Tibetan gazelle, wolves, and critical wetlands for the black-necked crane.', status: 'Wildlife Sanctuary' },
    { name: 'Karakoram Wildlife Sanctuary', slug: 'karakoram-sanctuary', area: '5,000 km²', established: '1987', icon: 'bi-mountain', color: '#7c3aed', desc: 'Remote sanctuary in the Karakoram Range covering some of the world\'s highest terrain — snow leopard, Ladakh urial, and ibex.', status: 'Wildlife Sanctuary' },
    { name: 'Tso Moriri Wetland (Ramsar)', slug: 'tso-moriri-wetland', area: '120 km²', established: '2002', icon: 'bi-water', color: '#0284c7', desc: ' A Ramsar-designated wetland of international importance — breeding ground for bar-headed geese, brahminy ducks, and black-necked cranes.', status: 'Ramsar Site' },
  ];
  ...
  threats = [
    ...
    { title: 'Overgrazing', icon: 'bi-flower3', desc: 'Pashmina goat herds have exploded — from 60,000 to 200,000+ in decades — degrading fragile grasslands and competing with wild herbivores like kiang and ibex.' },
  ...
  videos = [
    ...
    { title: 'Secret Life of Pangong Tso', desc: 'Discover the extraordinary ecosystem of the world\'s highest salt lake — from bar-headed geese to microscopic life.', duration: '18 min', type: 'Nature', gradient: 'linear-gradient(135deg, #0f2b46, #0284c7)', icon: 'bi-film', youtubeId: 'zNFmzjxQGHk' },
    { title: 'Chadar: Walking on Frozen Rivers', desc: 'The legendary frozen Zanskar River trek — one of the world\'s most extreme winter journeys.', duration: '35 min', type: 'adventure', gradient: 'linear-gradient(135deg, #1a365d, #2b5797)', icon: 'bi-camera-reels', youtubeId: '5PEbw7r3mYE' },
