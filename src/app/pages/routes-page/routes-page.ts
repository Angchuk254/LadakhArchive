...
export class RoutesPage {
  ...
  stats = [
    ...
    { icon: 'bi-calendar-heart', value: 'Junâ€“Sep', label: 'Best Season' },
  ...
  highways = [
    {
      name: 'Manaliâ€“Leh Highway',
      distance: '474 km',
      duration: '12â€“14 hours',
      ...
      highlights: [
        ...
        'Sarchu â€” Overnight stop',
        'Lachalung La (16,598 ft)',
        'Gata Loops â€” 21 hairpin bends',
        'Pang â€” High-altitude camp',
        'Tanglang La (16,050 ft)',
        'More Plains â€” Moonlike landscape',
        'Upshi â€” Indus Valley entry',
      ],
      description:
    ...
    {
      name: 'Srinagarâ€“Leh Highway (NH1)',
      distance: '434 km',
      duration: '10â€“12 hours',
      season: 'May â€“ November',
      maxAltitude: '11,578 ft (Zoji La)',
      icon: 'bi-car-front',
      color: '#3b82f6',
      highlights: [
        'Sonamarg â€” Golden meadow',
        'Zoji La (11,578 ft) â€” Gateway to Ladakh',
        'Drass â€” 2nd coldest inhabited place',
        'Kargil â€” Halfway stop',
        'Mulbekh â€” Giant Maitreya Buddha',
        'Namika La (12,139 ft)',
        'Fotu La (13,479 ft) â€” Highest on this route',
        'Lamayuru â€” Moonland monastery',
        'alchi â€” ancient temple complex',
  ...
  passes = [
    ...
    { slug: 'tanglang-la', name: 'Tanglang La', altitude: '17,582 ft', road: 'Manaliâ€“Leh Hwy', status: 'Motorable', icon: 'bi-flag', description: 'Second highest pass on the Manaliâ€“Leh Highway, offers panoramic views of the Zanskar range.' },
    { slug: 'lachalung-la', name: 'Lachalung La', altitude: '16,598 ft', road: 'Manaliâ€“Leh Hwy', status: 'Motorable', icon: 'bi-flag', description: 'Located near the famous Gata Loops with 21 hairpin bends, a thrilling driving experience.' },
    { slug: 'baralacha-la', name: 'Baralacha La', altitude: '16,017 ft', road: 'Manaliâ€“Leh Hwy', status: 'Motorable', icon: 'bi-flag', description: 'The boundary between Lahaul (Himachal) and Ladakh, source of the Bhaga and Yunam rivers.' },
    ...
    { slug: 'fotu-la', name: 'Fotu La', altitude: '13,479 ft', road: 'Srinagarâ€“Leh Hwy', status: 'Motorable', icon: 'bi-flag', description: 'Highest point on the Srinagarâ€“Leh Highway, near the famous Lamayuru Monastery.' },
    { slug: 'zoji-la', name: 'Zoji La', altitude: '11,578 ft', road: 'Srinagarâ€“Leh Hwy', status: 'Motorable', icon: 'bi-flag', description: 'The gateway to Ladakh from Kashmir. The Zoji La tunnel (under construction) will make it all-weather.' },
  ];
  ...
  roadTrips = [
    ...
    },
    {
      ...
      difficulty: 'Very Difficult',
      color: '#dc2626',
      keyStops: ['Spangmik', 'Manâ€“Merak', 'Chushul', 'Rezang La War Memorial', 'Nyoma', 'Korzok'],
      description: 'The ultimate Changthang plateau circuit connecting both legendary lakes. Extremely remote with no fuel stations â€” requires full self-sufficiency. Passes through military areas.',
  ...
  treks = [
    ...
    },
    {
      ...
      description: 'Known as the "Baby Trek" of Ladakh â€” perfect for beginners and families. Walk through charming villages with homestays, apricot orchards, and monastery visits.',
    },
  ];

  /* â”€â”€ Cycling Routes â”€â”€ */
  cyclingRoutes = [
    { name: 'Manali to Leh', distance: '474 km', duration: '8â€“12 days', difficulty: 'Extreme', maxAltitude: '16,050 ft', description: 'The ultimate cycling challenge in India. Five major passes, extreme altitude, and stunning isolation.' },
    ...
    { name: 'Leh to Pangong (via Chang La)', distance: '160 km', duration: '2â€“3 days', difficulty: 'Hard', maxAltitude: '17,688 ft', description: 'Cross Chang La and descend to the magical Pangong Lake. Remote stretches require self-sufficiency.' },
    { name: 'Srinagar to Leh', distance: '434 km', duration: '5â€“7 days', difficulty: 'Hard', maxAltitude: '13,479 ft', description: 'Slightly gentler than Manali route with lower passes but longer stretches. Rich cultural stops along the way.' },
  ];

  /* â”€â”€ Practical Information â”€â”€ */
  permits = [
    { area: 'Nubra Valley', type: 'Inner Line Permit (ILP)', cost: 'â‚¹0 for Indians online', duration: '7 days', apply: 'DC Office Leh / Online portal', note: 'Foreign nationals need separate PaP through registered travel agent.' },
    { area: 'Pangong Tso', type: 'Inner Line Permit (ILP)', cost: 'â‚¹0 for Indians online', duration: '7 days', apply: 'DC Office Leh / Online portal', note: 'Foreigners allowed only up to Spangmik (7 km from the lake).' },
    { area: 'Tso Moriri', type: 'Inner Line Permit (ILP)', cost: 'â‚¹0 for Indians online', duration: '7 days', apply: 'DC Office Leh / Online portal', note: 'Route via Chumur requires additional permit clearance.' },
    { area: 'Hanle', type: 'Inner Line Permit + Special', cost: 'â‚¹0 for Indians online', duration: '7 days', apply: 'DC Office Leh', note: 'Restricted area near LaC. Permit approval can take 1â€“2 days.' },
    { area: 'Zanskar', type: 'No special permit', cost: 'N/a', duration: 'N/a', apply: 'N/a', note: 'Open for all Indian and foreign nationals. Road access only Julâ€“Oct.' },
    { area: 'Turtuk / Tyakshi', type: 'Inner Line Permit (ILP)', cost: 'â‚¹0 for Indians online', duration: '7 days', apply: 'DC Office Leh / Online portal', note: 'Last Indian village before the LoC. Was part of Pakistan until 1971.' },
  ];

  /* â”€â”€ Fuel & Service Stations â”€â”€ */
  fuelStations = [
    { location: 'Leh (Main City)', type: 'Petrol + Diesel + EV Charging', note: 'Multiple stations â€” last reliable fuel before most routes.' },
    { location: 'Karu', type: 'Petrol + Diesel', note: 'Junction point for Pangong and Tso Moriri routes.' },
    { location: 'Kargil', type: 'Petrol + Diesel', note: 'Halfway on Srinagarâ€“Leh Highway. Last fuel before Zanskar.' },
    ...
    { location: 'Upshi', type: 'Limited', note: 'Small station on Manaliâ€“Leh route. Not always operational.' },
  ];

  /* â”€â”€ Seasonal Calendar â”€â”€ */
  seasons = [
    { months: 'January â€“ March', status: 'Winter Closed', color: '#60a5fa', roads: 'Most roads closed. Only Leh airport operational.', activity: 'Chadar Trek (Frozen River), Monastery visits in Leh.', temp: '-15ÂaC to -5ÂaC' },
    { months: 'april â€“ May', status: 'Opening Season', color: '#34d399', roads: 'Srinagarâ€“Leh opens mid-May. Manaliâ€“Leh opens late May/June.', activity: 'Limited travel. Snow clearance ongoing. Flights available.', temp: '-2ÂaC to 12ÂaC' },
    { months: 'June â€“ July', status: 'Peak Season', color: '#fbbf24', roads: 'all roads open. Inner routes accessible.', activity: 'all road trips, treks, and cycling routes fully operational.', temp: '8ÂaC to 28ÂaC' },
    { months: 'august â€“ September', status: 'Monsoon Edge', color: '#fb923c', roads: 'Landslides possible on Manali route. Inner routes mostly fine.', activity: 'Trekking at its best. Changthang wildflowers. Festivals.', temp: '7ÂaC to 25ÂaC' },
    { months: 'October â€“ November', status: 'Closing Season', color: '#f87171', roads: 'Manaliâ€“Leh closes Oct. Inner routes close by late Oct.', activity: 'Last window for road trips. Crystal-clear skies for photography.', temp: '-5ÂaC to 15ÂaC' },
