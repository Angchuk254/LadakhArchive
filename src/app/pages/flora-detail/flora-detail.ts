  ...
  plants: FloraData[] = [
    {
      ...
      icon: 'bi-flower2',
      color: '#2e86c1',
      elevation: '3,800â€“5,000m',
      description: 'The legendary Himalayan blue poppy â€” one of the most sought-after alpine flowers on Earth, with delicate sky-blue petals blooming briefly in July at high passes.',
      overview: 'The Himalayan Blue Poppy is considered the holy grail of alpine botany. Its stunning sky-blue to violet petals â€” a colour almost unheard of in poppies â€” bloom for barely two weeks in July on scree slopes and rocky meadows above 3,800m.\n\nIn Ladakh, blue poppies are found along the high passes connecting the Markha Valley, near Hemis National Park, and on the approaches to Stok Kangri. They prefer north-facing slopes with moist, well-drained soil and partial snow cover.\n\nThe pigment responsible for the blue colour (delphinidin) is pH-dependent â€” the same plant can produce blue, violet, or purple flowers depending on soil acidity. This has made them notoriously difficult to cultivate outside their native range, adding to their mystique.\n\nTraditional amchi medicine uses dried petals for treating respiratory ailments and as a mild analgesic.',
      highlights: ['Sky-blue petals â€” rarest poppy colour', 'Blooms only 2 weeks in July', 'Found above 3,800m on passes', 'pH-dependent petal colour', 'Used in traditional amchi medicine', 'Holy grail of alpine botany'],
      uses: 'In traditional amchi (Tibetan) medicine, dried blue poppy petals are used as a mild pain reliever and to treat respiratory conditions. The plant also has ornamental significance â€” Victorian-era plant hunters risked their lives collecting seeds. Today, botanical gardens worldwide attempt (mostly unsuccessfully) to grow blue poppies, typically requiring acidic soil, mist, and cool temperatures that are difficult to replicate.',
      ecology: 'Blue poppies are monocarpic in some species â€” they grow for several years as a rosette before flowering once and dying. They depend on specific pollinators including alpine bumblebees and certain hover flies. as pioneer species on scree slopes, they help stabilize loose rocky substrate. Climate change threatens their habitat by reducing snow cover and shifting temperature zones upward.',
      ...
      photos: [
        ...
        { title: 'Single Bloom Close-up', image: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&q=80&w=800', icon: 'bi-zoom-in', location: 'Markha Valley', desc: 'Translucent sky-blue petals with golden stamens â€” the hallmark of the Himalayan blue poppy.' },
        ...
        { title: 'Rosette Stage', image: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&q=80&w=800', icon: 'bi-flower1', location: 'Stok Range', desc: 'The basal rosette stage â€” plants grow for 2â€“5 years before producing their single flowering stem.' },
        { title: 'Violet Variant', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-palette', location: 'Kongmaru La', desc: 'Deep violet petals on this specimen â€” the colour varies with soil acidity.' },
      ],
    ...
    },
    {
      ...
      icon: 'bi-snow',
      color: '#7c3aed',
      elevation: '3,500â€“5,200m',
      description: 'The iconic white-woolly alpine flower found on rocky slopes â€” its felt-like petals are an adaptation to UV radiation and extreme cold.',
      overview: 'Edelweiss â€” the "noble white" â€” is perhaps the most famous alpine flower in the world. Its distinctive star-shaped white bracts (often mistaken for petals) are covered in dense woolly hairs that serve as a UV shield and thermal insulator.\n\nIn Ladakh, edelweiss grows on exposed rocky slopes and cliff ledges from 3,500m to over 5,200m. These harsh, exposed locations would kill most plants, but edelweiss has evolved remarkable adaptations: the woolly covering reflects up to 95% of UV radiation, prevents frost damage, and reduces water loss.\n\nRecent scientific research has discovered that edelweiss fibres have a nanotechnology-like structure â€” each hair is made of parallel fibres 0.18 micrometres in diameter that absorb UV wavelengths. This has inspired new UV-blocking materials and sunscreen formulations.\n\nIn Ladakhi culture, finding edelweiss is considered auspicious. The flowers are dried and placed on household altars.',
      ...
      photos: [
        ...
        { title: 'Cluster Colony', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-people-fill', location: 'Ganda La, 4,900m', desc: 'a rare cluster of edelweiss â€” multiple plants anchored together in a shallow rock crevice.' },
        { title: 'Dried altar Flower', image: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&q=80&w=800', icon: 'bi-star-fill', location: 'Leh Household', desc: 'Dried edelweiss on a household altar â€” considered auspicious and placed for good fortune.' },
      ],
      ...
      facts: [
        ...
        { icon: 'bi-calendar', label: 'Bloom Period', value: 'Julyâ€“September' },
        { icon: 'bi-rulers', label: 'Height', value: '5â€“20 cm' },
        { icon: 'bi-shield', label: 'UV Reflection', value: '~95%' },
        { icon: 'bi-geo-alt', label: 'Elevation', value: '3,500â€“5,200m' },
    ...
    },
    {
      ...
      photos: [
        { title: 'Orange Berry Clusters', image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=800', icon: 'bi-tree-fill', location: 'Indus Valley', desc: 'Branches laden with bright orange berries in autumn â€” thousands of nutrient-packed fruits per bush.' },
        ...
        { title: 'Juice Production', image: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&q=80&w=800', icon: 'bi-cup-straw', location: 'Leh Market', desc: 'Fresh sea buckthorn juice â€” a popular health drink sold across Ladakh\'s markets.' },
        { title: 'Root Nodules', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-gear', location: 'Nubra Valley', desc: 'Nitrogen-fixing root nodules â€” the secret to this plant\'s ability to thrive in poor soils.' },
        { title: 'Women\'s Cooperative', image: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&q=80&w=800', icon: 'bi-people-fill', location: 'Stakna', desc: 'Local women harvesting berries â€” cooperatives provide sustainable livelihood from wild bounty.' },
      ],
      ...
      facts: [
        ...
        { icon: 'bi-geo-alt', label: 'Elevation', value: '2,500â€“4,500m' },
        { icon: 'bi-rulers', label: 'Shrub Height', value: '2â€“4 metres' },
      ],
    ...
    },
    {
      ...
      photos: [
        { title: 'Blooming Hedgerow', image: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&q=80&w=800', icon: 'bi-flower1', location: 'Leh', desc: 'Wild roses in full bloom along an irrigation channel â€” pink petals against ancient stone walls.' },
        { title: 'Rose Hip Harvest', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-cup-straw', location: 'alchi', desc: 'Bright red rose hips ready for harvest â€” each one packed with Vitamin C for winter tea.' },
        ...
        { title: 'Rose Hip Tea', image: 'https://images.unsplash.com/photo-1506220926022-cc2c17377c86?auto=format&fit=crop&q=80&w=800', icon: 'bi-cup-hot', location: 'Ladakhi Home', desc: 'Traditional rose hip tea â€” Ladakh\'s beloved welcome drink served to guests and travellers.' },
      ],
      ...
      facts: [
        ...
        { icon: 'bi-calendar', label: 'Bloom Period', value: 'Juneâ€“July' },
        { icon: 'bi-rulers', label: 'Height', value: 'Up to 2 metres' },
        { icon: 'bi-geo-alt', label: 'Elevation', value: '3,000â€“4,200m' },
        { icon: 'bi-capsule', label: 'Rose Hip Vitamin C', value: '20Ã— more than lemons' },
        { icon: 'bi-egg', label: 'Hip Harvest', value: 'Septemberâ€“October' },
      ],
    ...
    },
    {
      ...
      photos: [
        ...
        { title: 'ancient Shrub', image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=800', icon: 'bi-clock-history', location: 'Hemis National Park', desc: 'a gnarled juniper shrub barely 80cm tall â€” estimated to be over 150 years old.' },
        { title: 'Berries Close-up', image: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&q=80&w=800', icon: 'bi-zoom-in', location: 'Markha Valley', desc: 'Blue-black juniper berries â€” used in traditional medicine and valued for flavouring.' },
        { title: 'Mountain Pass Offering', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-flag', location: 'Khardung La', desc: 'Juniper smoke rising from a stone incense burner at a high pass â€” prayer flags fluttering above.' },
        { title: 'Rocky Habitat', image: 'https://images.unsplash.com/photo-1590059530472-7634f596ee24?auto=format&fit=crop&q=80&w=800', icon: 'bi-geo-alt', location: 'Stok Range, 4,500m', desc: 'Juniper clinging to an exposed rocky slope â€” one of the highest woody plants in the region.' },
      ],
      ...
      facts: [
        ...
        { icon: 'bi-rulers', label: 'Height', value: '0.3â€“3 metres' },
        { icon: 'bi-clock-history', label: 'age at 1m Height', value: '100+ years' },
        { icon: 'bi-geo-alt', label: 'Elevation', value: '3,200â€“4,800m' },
    ...
    },
    {
      ...
      ecology: 'Ephedra is a remarkable survivor â€” its photosynthetic green stems (not true leaves) minimize water loss in the extreme cold-desert environment. The plant\'s deep root system accesses moisture far below the surface. It provides ground cover that reduces soil erosion on steep slopes. Small birds and rodents shelter within its dense, low branches.',
      ...
      photos: [
        ...
        { title: 'Red Berries', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-egg', location: 'Hemis National Park', desc: 'Small red berry-like cones that appear in summer â€” technically not true fruits.' },
        ...
        { title: 'Nomad\'s Remedy', image: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&q=80&w=800', icon: 'bi-bag', location: 'Changpa Camp', desc: 'a Changpa nomad\'s pouch of dried ephedra stems â€” carried on long journeys across the plateau.' },
      ],
      image: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&q=80&w=600',
      heroImage: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&q=80&w=1600',
      facts: [
        ...
        { icon: 'bi-rulers', label: 'Height', value: '15â€“60 cm' },
        { icon: 'bi-geo-alt', label: 'Elevation', value: '3,000â€“5,000m' },
    ...
    },
    {
      ...
      overview: 'Willows â€” known locally as "changma" â€” are the only true trees in much of Ladakh. In a landscape dominated by barren rock and sparse scrub, willow-lined irrigation channels and village groves provide a lifeline of greenery, shade, and essential resources.\n\nSeveral species of willow grow in Ladakh, typically along water channels, stream banks, and in village groves. They can reach heights of 10â€“15 metres and are fast-growing compared to other Ladakhi plants (useful logs can be produced in 15â€“20 years).\n\nWillows serve multiple critical functions: their branches are woven into baskets and fencing, the wood provides fuel and building material, the roots stabilize riverbanks, and the canopy creates islands of shade and moisture that support a diverse understorey of herbs and grasses.\n\nIn autumn, the turning willow leaves create Ladakh\'s only autumn colour display â€” ribbons of gold and yellow winding through otherwise brown valleys.',
      highlights: ['Only significant tree in Ladakh', 'Lines irrigation channels', 'Branches woven into baskets', 'autumn gold â€” Ladakh\'s fall colour', 'Fast-growing: logs in 15â€“20 years', 'Critical shade and shelter provider'],
      uses: 'Willow wood is the primary construction timber and fuel source in many Ladakhi villages. Branches are woven into baskets, fencing, and roof structures. The bark contains salicin (related to aspirin) â€” used in traditional medicine for pain and fever. Willow-lined channels create shade that reduces evaporation from irrigation water.',
      ecology: 'Willows are the keystone tree species of Ladakh\'s oasis-like settlement landscapes. Their root systems prevent channel bank erosion. The canopy creates a microclimate â€” up to 10ÂaC cooler than surrounding exposed land â€” supporting understorey plants, insects, and nesting birds. Fallen leaves provide organic matter that enriches the poor desert soils.',
      ...
      photos: [
        { title: 'Irrigation Channel', image: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&q=80&w=800', icon: 'bi-bezier2', location: 'Leh', desc: 'ancient willows lining a traditional irrigation channel â€” Green ribbons through the brown landscape.' },
        { title: 'autumn Gold', image: 'https://images.unsplash.com/photo-1506220926022-cc2c17377c86?auto=format&fit=crop&q=80&w=800', icon: 'bi-brightness-high', location: 'alchi', desc: 'Willows in autumn â€” the only significant fall colour display in Ladakh\'s desert valleys.' },
        ...
        { title: 'ancient Giant', image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=800', icon: 'bi-tree', location: 'Hemis Shukpachan', desc: 'One of Ladakh\'s oldest willows â€” a massive trunk providing shade for generations.' },
        { title: 'Village Oasis', image: 'https://images.unsplash.com/photo-1590059530472-7634f596ee24?auto=format&fit=crop&q=80&w=800', icon: 'bi-house', location: 'Shey Palace', desc: 'a willow grove creating an oasis of green around a Ladakhi village â€” shelter from sun and wind.' },
      ],
      image: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&q=80&w=600',
      heroImage: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&q=80&w=1600',
      facts: [
        { icon: 'bi-rulers', label: 'Height', value: '10â€“15 metres' },
        { icon: 'bi-clock', label: 'Useful Logs In', value: '15â€“20 years' },
        { icon: 'bi-geo-alt', label: 'Elevation', value: '2,800â€“4,000m' },
    ...
    },
    {
      ...
      overview: 'Caragana â€” known locally as "burtse" â€” is the unsung hero of the Changthang ecosystem. This small, thorny, densely branched shrub grows across the vast cold desert steppe from 3,500m to 5,000m, where it serves as the primary fuel source for Changpa nomadic herders.\n\nFor centuries, dried caragana has been the only available fuel on the treeless Changthang plateau. Nomads collect bundles during summer and store them for winter burning. The woody branches produce a hot, slow-burning fire ideal for cooking and heating black yak-hair tents in sub-zero temperatures.\n\nEcologically, caragana is equally important. Like sea buckthorn, it is a nitrogen-fixing legume â€” its root nodules contain bacteria that convert atmospheric nitrogen into soil nutrients. This enriches the extremely poor desert soil, benefiting neighbouring grasses and herbs.\n\nThe dense, thorny branches also prevent wind erosion, create micro-shelters for insects and small rodents, and provide nesting sites for ground-nesting birds.',
      ...
      photos: [
        { title: 'Changthang Fuel', image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=800', icon: 'bi-fire', location: 'Changthang Plateau', desc: 'Dried caragana bundles stacked outside a Changpa nomad tent â€” winter fuel supply.' },
        { title: 'Thorny Shrub', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-shield', location: 'Hanle', desc: 'Dense, thorny branches of caragana â€” nature\'s barbed wire protecting the fragile steppe soil.' },
        { title: 'Yellow Flowers', image: 'https://images.unsplash.com/photo-1590059530472-7634f596ee24?auto=format&fit=crop&q=80&w=800', icon: 'bi-flower1', location: 'Puga Valley', desc: 'Small yellow flowers appearing in summer â€” a brief splash of colour in the austere landscape.' },
        { title: 'Root Nodules', image: 'https://images.unsplash.com/photo-1510522103504-297929785002?auto=format&fit=crop&q=80&w=800', icon: 'bi-gear', location: 'Changthang', desc: 'Nitrogen-fixing root nodules â€” the hidden mechanism that enriches the cold desert soil.' },
        { title: 'Nomad Camp', image: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&q=80&w=800', icon: 'bi-house', location: 'Korzok', desc: 'a Changpa nomad camp with stacks of dried caragana â€” the lifeline of the treeless plateau.' },
      ],
      image: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=600',
      heroImage: 'https://images.unsplash.com/photo-1544284560-6479f6eeb248?auto=format&fit=crop&q=80&w=1600',
      facts: [
        { icon: 'bi-rulers', label: 'Height', value: '30â€“100 cm' },
        { icon: 'bi-geo-alt', label: 'Elevation', value: '3,500â€“5,000m' },
        { icon: 'bi-fire', label: 'Use', value: 'Primary nomad fuel' },
        { icon: 'bi-gear', label: 'Root Feature', value: 'Nitrogen-fixing nodules' },
        { icon: 'bi-flower1', label: 'Flower Colour', value: 'Yellow (Juneâ€“July)' },
