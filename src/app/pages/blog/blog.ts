...
export class Blog {
  ...
  constructor() {
    const title = 'Ladakh Blog â€” Stories, History, Nature & Travel | The Ladakh archive';
  ...
  posts = [
    ...
    },
    {
      ...
      excerpt: 'How local communities and researchers work together to protect the elusive ghost of the mountains in Hemis National Park â€” India\'s largest national park.',
      category: 'Nature',
      date: 'Feb 3, 2025',
      readTime: '6 min read',
      icon: 'bi-tree',
    ...
    },
    {
      ...
      excerpt: 'a deep dive into Ladakh\'s grandest monastic festival â€” the sacred Cham dances, the giant thangka, and the spiritual significance of Guru Padmasambhava\'s birth celebration.',
      category: 'Culture',
      date: 'apr 10, 2025',
      readTime: '7 min read',
      icon: 'bi-mask',
    ...
    },
    {
      ...
      excerpt: 'Riding one of the world\'s highest motorable passes â€” what to expect, how to prepare, and the breathtaking views that await on the other side.',
      category: 'Travel',
      date: 'May 5, 2025',
      readTime: '5 min read',
    ...
    },
    {
      ...
      excerpt: 'The last nomadic communities of Ladakh â€” their pashmina goats, seasonal migrations, and the challenges of preserving a centuries-old way of life.',
      category: 'People',
      date: 'Jul 2, 2025',
      readTime: '8 min read',
      icon: 'bi-people',
    ...
    },
    {
      ...
      excerpt: 'Exploring the real Pangong Lake â€” not just the film set, but a fragile high-altitude ecosystem stretching 134 km between India and Tibet.',
      category: 'Nature',
      date: 'aug 14, 2025',
      readTime: '6 min read',
      icon: 'bi-water',
    ...
    },
    {
      ...
      excerpt: 'a first-hand account of walking the frozen Zanskar River in -25ÂaC â€” one of the most extreme and unforgettable treks on the planet.',
      category: 'Travel',
      date: 'Oct 8, 2025',
      readTime: '7 min read',
      icon: 'bi-snow2',
    ...
    },
    {
      ...
      excerpt: 'Exploring the rich Balti and Purig traditions of Kargil district â€” the music, cuisine, architecture, and the unique cultural identity that sets it apart.',
      category: 'Culture',
      date: 'Nov 15, 2025',
      readTime: '8 min read',
    ...
    },
    {
      ...
      excerpt: 'Three years after becoming a UT â€” assessing the impact on governance, development, employment, and the demand for the Sixth Schedule.',
      category: 'Politics',
      date: 'Dec 1, 2025',
