...
export class Culture {
  ...
  constructor() {
    const title = 'Culture & People of Ladakh â€” Festivals, Traditions, Languages & Ethnic Groups';
  ...
  videos = [
    ...
    { title: 'Sacred Dances of Hemis', desc: 'Witness the spectacular Cham dances at Hemis Monastery â€” centuries-old masked rituals celebrating the triumph of good over evil.', duration: '18 min', type: 'Cultural', gradient: 'linear-gradient(135deg, #4a1942, #7c3aed)', icon: 'bi-film', youtubeId: 'Yqx2s0nJmHQ' },
    ...
    { title: 'Weaving Pashmina: art of the Changpa', desc: 'From goat to shawl â€” the painstaking journey of Ladakhi Pashmina wool, the world\'s finest and softest fiber.', duration: '15 min', type: 'Craft', gradient: 'linear-gradient(135deg, #1a365d, #2b5797)', icon: 'bi-camera-video', youtubeId: 'QJuvqMfXLqs' },
    ...
    { title: 'a Year in Ladakh: Four Seasons', desc: 'From frozen winters to blooming apricot summers â€” experience the rhythms of life at 3,500 metres through a full year.', duration: '45 min', type: 'Lifestyle', gradient: 'linear-gradient(135deg, #0f2b46, #1a5276)', icon: 'bi-film', youtubeId: 'HjBo--1n8lI' },
  ];
  ...
  ethnicGroups = [
    ...
    },
    {
      ...
      desc: 'The Baltis of Kargil are of Tibetan descent who converted to Shia Islam centuries ago. They preserve a unique blend of Tibetan and Islamic cultures, speaking Balti â€” one of the most archaic forms of Tibetan.',
    ...
    },
    {
      ...
      religion: 'Buddhist',
      language: 'Ladakhi',
      desc: 'The Mon community are traditional musicians and blacksmiths of Ladakh. Though historically marginalized, they are the keepers of Ladakh\'s performing arts â€” playing drums, shawm, and other instruments at every monastery festival.',
  ...
  festivals = [
    {
      ...
      overview: 'Losar is the grandest and most anticipated celebration in Ladakhi culture, marking the beginning of a new year according to the Tibetan calendar. Preparations begin weeks in advance â€” homes are whitewashed, floors scrubbed, and special offerings are prepared. On Losar eve, families gather to eat "guthuk" â€” a special noodle soup with hidden symbolic items (coal for bad luck, wool for kindness, chili for talkative nature). The 15-day celebration features archery competitions, folk dances, chang (barley beer) drinking, visits to monasteries, and elaborate feasts. Each household prepares a "chemo" â€” a decorated offering tower â€” and the community performs masked Cham dances to drive away evil spirits and welcome prosperity.',
    ...
    },
    {
      ...
      overview: 'Saga Dawa is considered the most sacred month in the Tibetan Buddhist calendar as it commemorates three momentous events in the life of Shakyamuni Buddha â€” his birth, enlightenment, and parinirvana (passing). The 15th day of the fourth Tibetan month is the most auspicious. During this period, Ladakhis intensify their religious practices: visiting monasteries for prayers, making offerings, circumambulating sacred sites like Shanti Stupa, releasing animals, and performing acts of generosity. Many observe vegetarianism and avoid killing any living beings. Monasteries hold special prayer sessions, butter lamp offerings, and scripture readings. It is believed that the karmic effects of all actions â€” positive or negative â€” are multiplied during this period.',
    ...
    },
    {
      ...
      overview: 'Muharram in Kargil is one of the most intense and deeply emotional religious observances in all of Ladakh. The Shia Muslim community of Kargil commemorates the martyrdom of Imam Hussain (grandson of Prophet Muhammad) at the Battle of Karbala in 680 CE. For the first ten days of the Islamic month of Muharram, the town transforms â€” black banners adorn buildings, community halls (imambaras) host nightly majlis (gatherings) where scholars recount the tragedy of Karbala through powerful oratory and marsiya (elegiac poetry). The observance reaches its climax on ashura (10th Muharram) with a massive procession through Kargil\'s streets featuring tazia (symbolic tombs), alam (standards), and communal expressions of grief. Despite the solemn nature, the event underscores deep community bonds.',
    ...
    },
    {
      ...
      color: '#dc2626',
      type: 'Buddhist',
      desc: 'Ladakh\'s most mystifying festival at Matho Monastery, where two monks become oracles â€” performing superhuman feats blindfolded, including slashing themselves and walking on walls.',
      overview: 'Matho Nagrang is perhaps the most extraordinary and unsettling festival in Ladakh, held at Matho Monastery â€” the only monastery of the Sakya order in the region. Two monks are chosen as oracles (rongtsans) and enter intense meditation for weeks before the festival. During the event, they are believed to become possessed by the monastery\'s protective deities. Blindfolded and in a trance state, they perform seemingly impossible feats â€” running along the narrow monastery walls high above the ground, slashing their bodies with swords (with wounds reportedly healing quickly), and making prophecies for the coming year. The oracles provide individual predictions and guidance when approached by devotees. The festival attracts large crowds and remains one of the most authentic and unaltered spiritual traditions in the Himalayas.',
  ...
  // ===== Traditional Dress =====
  dress = [
    { name: 'Goncha / Kos', gender: 'Unisex', icon: 'bi-person-standing', desc: 'The traditional Ladakhi robe â€” a heavy woolen garment tied at the waist with a sash (skerag). Creates a pouch above the waist for carrying essentials. Maroon or brown for men, bright colors for women.', material: 'Wool & Yak hair' },
    { name: 'Perak', gender: 'Women', icon: 'bi-gem', desc: 'The iconic Ladakhi cobra-shaped headpiece studded with turquoise stones, symbolizing wealth and status. Can weigh 2â€“5 kg and contain over 100 turquoise pieces. Passed down through generations.', material: 'Turquoise, leather, cloth' },
    { name: 'Tibi (Hat)', gender: 'Men', icon: 'bi-cap-front', desc: 'a cylindrical felt or velvet hat, sometimes fur-lined, worn by Ladakhi men. Styles vary by region â€” the Balti wear a distinctive rolled-wool cap called "balti topi."', material: 'Felt, velvet, fur' },
  ...
  // ===== Cuisine =====
  cuisine = [
    { name: 'Thukpa', icon: 'bi-cup-hot', category: 'Soup/Noodle', desc: 'Ladakh\'s staple comfort food â€” a hearty noodle soup with vegetables and meat, flavored with garlic, ginger, and local spices. Every household has its own recipe.' },
    ...
    { name: 'Butter Tea (Gur Gur Cha)', icon: 'bi-cup-straw', category: 'Beverage', desc: 'Salted tea churned with yak butter â€” the essential Ladakhi drink. Providing warmth, energy, and hydration at high altitude. an acquired taste for visitors.' },
    ...
    { name: 'Chhurpi (Cheese)', icon: 'bi-box', category: 'Dairy', desc: 'Hard dried yak cheese that Changpa nomads carry as a protein-rich snack. Extremely hard â€” meant to be chewed slowly over hours. also used in curries when softened.' },
  ...
  performingArts = [
    ...
    { name: 'Jabro', icon: 'bi-music-note-list', type: 'Folk Dance', desc: 'a group dance performed at celebrations â€” men and women form a circle and dance with graceful hand and body movements, singing traditional songs in unison.', where: 'Throughout Ladakh' },
    { name: 'Shon', icon: 'bi-play-circle', type: 'Traditional Opera', desc: 'Ladakhi opera combining song, dance, and drama â€” often depicting Buddhist tales, historical events, or moral stories. Performed in open courtyards with elaborate costumes.', where: 'Leh, village festivals' },
    { name: 'Surna & Daman', icon: 'bi-speaker-fill', type: 'Instruments', desc: 'The surna (oboe-like shawm) and daman (large drum) duo â€” played by the Mon community at every monastery festival, wedding, and procession. The essential soundtrack of Ladakh.', where: 'all monastery festivals' },
  ...
  crafts = [
    ...
    { name: 'Wood Carving', icon: 'bi-hammer', color: '#059669', desc: 'Elaborate carving of window frames, door lintels, and monastery interiors with Buddhist motifs â€” lotus flowers, dragons, snow lions, and cloud patterns.' },
    ...
    { name: 'Pottery & Clay', icon: 'bi-urn', color: '#dc2626', desc: 'Traditional clay pottery for daily use â€” cups, storage jars, and incense burners. also includes the remarkable clay sculptures found in ancient monasteries like alchi.' },
  ...
  // ===== Daily Life =====
  dailyLife = [
    { title: 'agricultural Cycle', icon: 'bi-flower1', desc: 'Life revolves around the short growing season (Mayâ€“September). Barley, wheat, and peas are staple crops. The harvest festival is a major celebration, and winter is spent in community gatherings and religious observances.' },
    ...
    { title: 'Community Service (Bes)', icon: 'bi-people', desc: 'Bes is the Ladakhi tradition of communal labor â€” villagers come together to help with house building, road repair, harvest, and monastery maintenance. It reflects the deep collective spirit of Ladakhi society.' },
