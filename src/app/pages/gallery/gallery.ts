...
export class Gallery {
  ...
  photos: GalleryPhoto[] = [
    ...
    // Monasteries
    { id: 6, title: 'Thiksey Monastery Dawn', category: 'monastery', location: 'Thiksey, Leh District', photographer: 'Rigzin Wangmo', desc: 'The 12-storey Thiksey Gompa â€” often called the "Mini Potala" â€” bathed in golden morning light with prayer flags fluttering.', gradient: 'linear-gradient(135deg, #c8702a, #e89b4e)', icon: 'bi-building', tags: ['Gompa', 'Buddhist', 'architecture'] },
    { id: 7, title: 'Hemis Monastery Interior', category: 'monastery', location: 'Hemis, Leh District', photographer: 'Tsewang Namgyal', desc: 'The ornate interior of Hemis â€” Ladakh\'s wealthiest monastery â€” with ancient thangka paintings and gold-plated Buddha statues.', gradient: 'linear-gradient(135deg, #92400e, #b45309)', icon: 'bi-lamp', tags: ['Hemis', 'Thangka', 'Interior'] },
    ...
    { id: 9, title: 'alchi ancient Murals', category: 'monastery', location: 'alchi, Leh District', photographer: 'Dorjay angchuk', desc: 'The exquisite 11th-century murals of alchi Monastery â€” among the finest examples of Kashmiri-Buddhist art surviving anywhere in the world.', gradient: 'linear-gradient(135deg, #7c2d12, #dc2626)', icon: 'bi-palette', tags: ['Murals', 'ancient', '11th Century'] },

    // People & Life
    { id: 10, title: 'Changpa Nomad Family', category: 'people', location: 'Changthang Plateau', photographer: 'Fatima Bano', desc: 'a Changpa nomadic family with their Pashmina goats on the windswept Changthang plateau at 15,000+ feet â€” preserving traditions spanning millennia.', gradient: 'linear-gradient(135deg, #059669, #10b981)', icon: 'bi-people', tags: ['Nomads', 'Changpa', 'Pashmina'] },
    { id: 11, title: 'Ladakhi Grandmother Spinning', category: 'people', location: 'Likir Village', photographer: 'Stanzin Dorjay', desc: 'an elderly Ladakhi woman spinning yak wool using a traditional hand spindle â€” a daily ritual passed through generations.', gradient: 'linear-gradient(135deg, #b45309, #d97706)', icon: 'bi-person', tags: ['Weaving', 'Village', 'Traditional'] },
    { id: 12, title: 'Balti Children at School', category: 'people', location: 'Turtuk, Nubra Valley', photographer: 'Mohd. Iqbal', desc: 'Smiling Balti children in Turtuk â€” India\'s northernmost village â€” walking to school through apricot orchards with the Karakoram as backdrop.', gradient: 'linear-gradient(135deg, #2563eb, #3b82f6)', icon: 'bi-emoji-laughing', tags: ['Children', 'Turtuk', 'Balti'] },
    { id: 13, title: 'Monk Debate at Likir', category: 'people', location: 'Likir Monastery', photographer: 'angmo Dolma', desc: 'Young monks engaged in philosophical debate at Likir Monastery â€” a centuries-old Buddhist tradition of intellectual challenge and learning.', gradient: 'linear-gradient(135deg, #7c3aed, #8b5cf6)', icon: 'bi-chat-dots', tags: ['Monks', 'Debate', 'Buddhist'] },

    // Festivals
    { id: 14, title: 'Hemis Festival Cham Dance', category: 'festival', location: 'Hemis Monastery', photographer: 'Rigzin Wangmo', desc: 'a masked dancer performing the sacred Cham dance at Hemis Tsechu â€” Ladakh\'s largest and most famous monastery festival celebrating Guru Padmasambhava.', gradient: 'linear-gradient(135deg, #dc2626, #ef4444)', icon: 'bi-music-note-beamed', tags: ['Cham', 'Hemis', 'Dance'] },
    ...
    { id: 16, title: 'Sindhu Darshan Festival', category: 'festival', location: 'Shey, Indus River', photographer: 'Stanzin Dorjay', desc: 'The grand Sindhu Darshan ceremony on the banks of the Indus River â€” celebrating India\'s civilisational river where it flows through Ladakh.', gradient: 'linear-gradient(135deg, #0c4a6e, #06b6d4)', icon: 'bi-water', tags: ['Sindhu', 'River', 'National'] },

    // Wildlife
    { id: 17, title: 'Snow Leopard in Hemis', category: 'wildlife', location: 'Hemis National Park', photographer: 'Dorjay angchuk', desc: 'The elusive Ghost of the Mountains â€” a snow leopard spotted in its natural habitat in Hemis National Park, home to the world\'s densest population.', gradient: 'linear-gradient(135deg, #475264, #737d8e)', icon: 'bi-github', tags: ['Snow Leopard', 'Hemis', 'Predator'] },
    { id: 18, title: 'Black-necked Cranes', category: 'wildlife', location: 'Hanle Marshes, Changthang', photographer: 'Padma Chorol', desc: 'a pair of endangered Black-necked Cranes â€” sacred in Buddhist tradition â€” breeding at the Hanle marshlands, their highest-altitude breeding ground.', gradient: 'linear-gradient(135deg, #1e3a5f, #2563eb)', icon: 'bi-feather', tags: ['Cranes', 'Hanle', 'Endangered'] },
    { id: 19, title: 'Wild Yaks of Changthang', category: 'wildlife', location: 'Changthang, 16,000 ft', photographer: 'Sonam angmo', desc: 'a herd of domesticated yaks grazing on the sparse Changthang vegetation â€” the backbone of nomadic life providing milk, wool, and transport.', gradient: 'linear-gradient(135deg, #713f12, #a16207)', icon: 'bi-circle', tags: ['Yak', 'Changthang', 'Nomadic'] },

    // adventure
    { id: 20, title: 'Chadar Trek â€” Frozen River', category: 'adventure', location: 'Zanskar River', photographer: 'Stanzin Dorjay', desc: 'Trekkers navigating the legendary Chadar Trek â€” walking on the frozen Zanskar River through narrow canyons in -25ÂaC temperatures.', gradient: 'linear-gradient(135deg, #0c4a6e, #0ea5e9)', icon: 'bi-snow', tags: ['Chadar', 'Trek', 'Winter'] },
    { id: 21, title: 'Cycling Khardung La', category: 'adventure', location: 'Khardung La, 17,982 ft', photographer: 'Mohd. Iqbal', desc: 'a cyclist conquering Khardung La â€” one of the world\'s highest motorable passes â€” with stunning views of the Karakoram and Ladakh Ranges.', gradient: 'linear-gradient(135deg, #059669, #10b981)', icon: 'bi-bicycle', tags: ['Cycling', 'Khardung La', 'Pass'] },
    { id: 22, title: 'Rafting on Indus River', category: 'adventure', location: 'Phey to Nimmu, Indus River', photographer: 'angmo Dolma', desc: 'White-water rafting through the Zanskar-Indus confluence â€” the dramatic meeting of two rivers amid towering cliffs and monasteries.', gradient: 'linear-gradient(135deg, #1e40af, #3b82f6)', icon: 'bi-water', tags: ['Rafting', 'Indus', 'Confluence'] },

    // Heritage & art
    { id: 23, title: 'Thangka Painting Master', category: 'heritage', location: 'Leh Old Town', photographer: 'Tsewang Namgyal', desc: 'a master thangka artist meticulously painting a Buddhist deity using natural mineral pigments â€” a meditative art form requiring years of training.', gradient: 'linear-gradient(135deg, #c8702a, #d97706)', icon: 'bi-brush', tags: ['Thangka', 'art', 'Buddhist'] },
    { id: 24, title: 'Pashmina Weaving', category: 'heritage', location: 'Leh Craft Centre', photographer: 'Fatima Bano', desc: 'The intricate art of Pashmina weaving â€” transforming the world\'s finest wool from Changra goats into luxurious shawls worth thousands.', gradient: 'linear-gradient(135deg, #7c3aed, #a78bfa)', icon: 'bi-align-center', tags: ['Pashmina', 'Weaving', 'Craft'] },
    { id: 25, title: 'ancient Rock Carvings', category: 'heritage', location: 'Dras, Kargil District', photographer: 'Mohd. Iqbal', desc: 'Petroglyphs and rock carvings dating back over 2,000 years at Dras â€” depicting ibex, hunters, and early Buddhist symbols along ancient trade routes.', gradient: 'linear-gradient(135deg, #713f12, #92400e)', icon: 'bi-pencil', tags: ['Petroglyphs', 'ancient', 'Rock art'] },
  ];

  /* â”€â”€ Videos â”€â”€ */
  videos: GalleryVideo[] = [
    { id: 1, title: 'Ladakh: Land of High Passes', category: 'landscape', duration: '22 min', youtubeId: 'dQw4w9WgXcQ', desc: 'an aerial journey across Ladakh\'s breathtaking landscapes â€” from the Indus Valley to the frozen lakes of Changthang.', gradient: 'linear-gradient(135deg, #0c4a6e, #0d9488)', icon: 'bi-camera-reels', tags: ['aerial', 'Documentary', 'Landscape'] },
    ...
    { id: 3, title: 'Chadar Trek: Walking on Ice', category: 'adventure', duration: '28 min', youtubeId: 'dQw4w9WgXcQ', desc: 'Follow trekkers on the legendary frozen river trek through Zanskar â€” one of the most extreme and beautiful treks on Earth.', gradient: 'linear-gradient(135deg, #1e3a5f, #4f46e5)', icon: 'bi-snow', tags: ['Chadar', 'Trek', 'Winter'] },
    ...
    { id: 7, title: 'Monasteries of Ladakh', category: 'monastery', duration: '25 min', youtubeId: 'dQw4w9WgXcQ', desc: 'a spiritual journey through Ladakh\'s most ancient monasteries â€” Hemis, Thiksey, alchi, Lamayuru, and Diskit.', gradient: 'linear-gradient(135deg, #b45309, #f59e0b)', icon: 'bi-building', tags: ['Monastery', 'Buddhist', 'Spiritual'] },
  ...
  collections = [
    { title: 'Frozen Ladakh', desc: 'Winter landscapes, frozen rivers, and the legendary Chadar Trek season â€” Ladakh at its most extreme and beautiful.', count: 35, icon: 'bi-snow3', color: '#0c4a6e' },
    ...
    { title: 'Faces of Ladakh', desc: 'Portraits of the people who call this high-altitude desert home â€” monks, nomads, farmers, artisans, and children.', count: 42, icon: 'bi-person', color: '#7c3aed' },
    ...
    { title: 'adventure Routes', desc: 'From Khardung La conquests to Indus rafting â€” the most thrilling adventure moments captured across Ladakh.', count: 19, icon: 'bi-bicycle', color: '#0d9488' },
  ];
