...
export class MonasteryDetail {
  ...
  monasteries: MonasteryData[] = [
    {
      ...
      highlights: [
        ...
        { label: 'National Park', detail: 'adjacent to Hemis National Park â€” prime snow leopard habitat' },
      ],
      gallery: [
      ...
      videoTitle: 'Inside Hemis Monastery', videoDesc: 'a visual journey through the largest monastery in Ladakh â€” its sacred halls, ancient thangkas, and the spectacular Hemis Tsechu festival.',
      lamas: [
      ...
      visitingHours: '8:00 aM â€“ 1:00 PM, 2:00 PM â€“ 6:00 PM', entryFee: 'â‚¹50', bestTime: 'June â€“ September (Hemis Tsechu in June/July)',
    ...
    },
    {
      ...
      highlights: [
        { label: 'Maitreya Buddha', detail: '15-metre (49 ft) seated Maitreya â€” largest such statue in Ladakh' },
      ...
      videoTitle: 'Thiksay Monastery at Dawn', videoDesc: 'Experience the magic of dawn prayers at Thiksay â€” the haunting dungchen horns, flickering butter lamps, and the golden Maitreya Buddha.',
      lamas: [
      ...
      visitingHours: '6:00 aM â€“ 6:00 PM', entryFee: 'â‚¹30', bestTime: 'June â€“ September (dawn visit recommended)',
    ...
    },
    {
      ...
      overview: 'Diskit Monastery is the oldest and largest Buddhist monastery in the Nubra Valley, dramatically perched on a cliff above the Shyok River. Founded in the 14th century, it belongs to the Gelug (Yellow Hat) school and serves as the administrative head of all Nubra Valley monasteries. In 2010, a towering 32-metre (106-foot) Maitreya Buddha statue was inaugurated below the monastery by the 14th Dalai Lama â€” now a landmark visible across the entire Nubra Valley. The monastery commands breathtaking views of the sand dunes of Hunder and the confluence of the Shyok and Nubra rivers.',
      ...
      visitingHours: '7:00 aM â€“ 6:00 PM', entryFee: 'â‚¹30', bestTime: 'July â€“ September',
    ...
    },
    {
      ...
      gallery: [
        ...
        { title: 'Carved Wooden Frames', desc: 'Intricate wood carvings on temple doorframes â€” Kashmiri craftsmanship', image: 'https://images.unsplash.com/photo-1621649692455-beae68ec0f47?auto=format&fit=crop&q=80&w=800' },
        { title: 'Mandala Paintings', desc: 'Detailed mandalas painted on temple ceilings â€” among the finest in asia', image: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&q=80&w=800' },
      ],
      videoTitle: 'alchi â€” Ladakh\'s ancient art Treasure', videoDesc: 'Explore the 1,000-year-old murals and sacred temples of alchi â€” a living museum of early Himalayan Buddhist art.',
      lamas: [
        { name: 'Rinchen Zangpo', title: 'The Great Translator (Lotsawa)', born: '958 CE', role: 'Founded 108 monasteries across the Western Himalayas', bio: 'Rinchen Zangpo (958â€“1055 CE) was the most influential figure in the second diffusion of Buddhism in western Tibet and Ladakh. Sent to Kashmir by the king of Guge to study, he translated numerous Sanskrit texts into Tibetan and founded an estimated 108 temples and monasteries. His legacy at alchi represents the finest surviving example of his cultural mission.', image: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&q=80&w=400' },
      ],
      nearbyAttractions: ['Likir Monastery', 'Basgo Fortress', 'Magnetic Hill', 'Lamayuru Monastery'],
      visitingHours: '8:00 aM â€“ 6:00 PM (no photography inside)', entryFee: 'â‚¹50', bestTime: 'May â€“ October',
    ...
    },
    {
      ...
      location: 'Lamayuru, Lehâ€“Srinagar Highway', altitude: '3,510 m',
      ...
      videoTitle: 'Lamayuru â€” The Moonland Monastery', videoDesc: 'Discover one of Ladakh\'s oldest and most dramatically situated monasteries, built on an otherworldly moonscape.',
      lamas: [
        { name: 'Naropa', title: 'Mahasiddha (Great accomplished One)', born: '1016 CE', role: 'Indian tantric master â€” spiritual ancestor of Lamayuru', bio: 'Naropa (1016â€“1100 CE) was one of the 84 Mahasiddhas of Indian Buddhist tantra. a scholar at Nalanda University, he renounced academic life to study under Tilopa and attained enlightenment through the famous "Six Yogas of Naropa." His meditation at Lamayuru sanctified the site and established it as a centre of tantric practice.', image: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&q=80&w=400' },
      ...
      visitingHours: '6:00 aM â€“ 6:00 PM', entryFee: 'â‚¹50', bestTime: 'June â€“ September (festival in June/July)',
      image: 'https://images.unsplash.com/photo-1544923246-77307dddd546?auto=format&fit=crop&q=80&w=800',
      heroImage: 'https://images.unsplash.com/photo-1544923246-77307dddd546?auto=format&fit=crop&q=80&w=1920',
    },
    {
    ...
    },
    {
      ...
      visitingHours: '8:00 aM â€“ 6:00 PM', entryFee: 'â‚¹30', bestTime: 'July â€“ august (Phyang Tsedup)',
      image: 'https://images.unsplash.com/photo-1544923246-77307dddd546?auto=format&fit=crop&q=80&w=800',
      heroImage: 'https://images.unsplash.com/photo-1544923246-77307dddd546?auto=format&fit=crop&q=80&w=1920',
    },
    {
      ...
      videoTitle: 'Stakna â€“ The Tiger\'s Nose Monastery', videoDesc: 'a peaceful visit to the Bhutanese-founded monastery perched above the Indus with its rare arhat paintings.',
      lamas: [
      ...
      visitingHours: '7:00 aM â€“ 6:00 PM', entryFee: 'â‚¹20', bestTime: 'June â€“ September',
      image: 'https://images.unsplash.com/photo-1544923246-77307dddd546?auto=format&fit=crop&q=80&w=800',
      heroImage: 'https://images.unsplash.com/photo-1544923246-77307dddd546?auto=format&fit=crop&q=80&w=1920',
    },
    {
      ...
      overview: 'Matho Monastery holds a unique position as the only monastery in Ladakh belonging to the Sakya order of Tibetan Buddhism. Located 26 km southeast of Leh, it is most famous for the extraordinary Matho Nagrang festival, during which two monks â€” selected as oracles (rongtsans) â€” enter intense meditation for weeks and then perform seemingly superhuman feats while blindfolded: walking along narrow monastery walls, slashing themselves with swords (with wounds reportedly healing miraculously), and delivering prophecies for the coming year.',
      history: 'Matho was founded around 1410 by Dugpa Dorje, a lama who brought the Sakya teachings from Tibet. The Sakya order, while widespread in Tibet, is represented only at Matho in all of Ladakh, making it unique in the religious landscape. The oracle tradition at Matho is believed to date back centuries and involves the two selected monks channeling the monastery\'s protective deities â€” Rongtsan and another named spirit. The accuracy of their prophecies is taken seriously by the local community, and the spectacle draws large crowds every February/March.',
      highlights: [
        { label: 'Oracle Festival', detail: 'Matho Nagrang â€” blindfolded monks perform superhuman trance feats' },
      ...
      videoTitle: 'Matho Nagrang â€” The Oracle Festival', videoDesc: 'Witness the most extraordinary spiritual event in Ladakh â€” blindfolded oracle monks performing superhuman feats.',
      lamas: [
      ...
      visitingHours: '7:00 aM â€“ 6:00 PM', entryFee: 'â‚¹30', bestTime: 'February/March (Matho Nagrang)',
      image: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&q=80&w=800',
      heroImage: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&q=80&w=1920',
    },
    {
      ...
      videoTitle: 'Chemrey â€” The Hidden Gem', videoDesc: 'Explore one of Ladakh\'s most photogenic and peaceful monasteries, built as a royal memorial in the 17th century.',
      lamas: [
      ...
      visitingHours: '6:00 aM â€“ 6:00 PM', entryFee: 'â‚¹30', bestTime: 'June â€“ September',
      image: 'https://images.unsplash.com/photo-1544923246-77307dddd546?auto=format&fit=crop&q=80&w=800',
      heroImage: 'https://images.unsplash.com/photo-1544923246-77307dddd546?auto=format&fit=crop&q=80&w=1920',
    },
    {
      ...
      highlights: [
        ...
        { label: 'Dalai Lama\'s Brother', detail: 'Headed by Ngari Rinpoche â€” the 14th Dalai Lama\'s younger brother' },
      ...
      visitingHours: '8:00 aM â€“ 6:00 PM', entryFee: 'â‚¹30', bestTime: 'June â€“ September',
      image: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&q=80&w=800',
      heroImage: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&q=80&w=1920',
    },
    {
      ...
      highlights: [
        ...
        { label: 'Oracle Festival', detail: 'Stok Guru Tsechu â€” monk oracle performs trance prophecies' },
      ...
      videoTitle: 'Stok â€” Where Royalty Meets Monasticism', videoDesc: 'Explore the unique combination of Ladakhi royal heritage and Buddhist monasticism at Stok Palace and Monastery.',
      lamas: [
      ...
      visitingHours: '7:00 aM â€“ 6:00 PM', entryFee: 'â‚¹50 (includes museum)', bestTime: 'February (Guru Tsechu), June â€“ Sept',
      image: 'https://images.unsplash.com/photo-1544923246-77307dddd546?auto=format&fit=crop&q=80&w=800',
      heroImage: 'https://images.unsplash.com/photo-1544923246-77307dddd546?auto=format&fit=crop&q=80&w=1920',
    },
  ];
  ...
  constructor() {
    ...
    if (found) {
      ...
      const title = `${found.name} â€” ${found.sect} Monastery, Ladakh | The Ladakh archive`;
