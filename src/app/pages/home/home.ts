...
export class Home {
  ...
  constructor() {
    const title = 'The Ladakh archive â€” Complete Guide to Ladakh\'s History, Culture & Nature';
  ...
  categories = [
    ...
    { icon: 'bi-bank', title: 'Politics & Society', desc: 'From Princely State to Union Territory â€” the political journey of a frontier region.', link: '/politics', color: '#dc2626', image: 'https://images.unsplash.com/photo-1544923246-77307dddd546?auto=format&fit=crop&q=80&w=800' },
    { icon: 'bi-mortarboard-fill', title: 'Education', desc: 'Reforming learning for the mountains â€” SECMOL, HIaL and the future of Ladakhi youth.', link: '/education', color: '#0284c7', image: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&q=80&w=800' },
    ...
    { icon: 'bi-search', title: 'Village Search', desc: 'Explore villages across Ladakh â€” search by name, pincode, block or district.', link: '/village-search', color: '#6d28d9', image: 'https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?auto=format&fit=crop&q=80&w=800' },
  ];
  ...
  funFacts = [
    { fact: 'Ladakh has the highest motorable pass in India â€” Umling La at 5,883m (19,300 ft).', icon: 'bi-signpost-2-fill', color: '#c8702a' },
    ...
    { fact: 'Ladakh receives barely 100mm of rainfall a year â€” making it one of the driest inhabited places on Earth.', icon: 'bi-cloud-sun', color: '#eab308' },
    { fact: 'Snow leopards outnumber humans in some valleys of the Hemis National Park.', icon: 'bi-binoculars', color: '#059669' },
    { fact: 'The Chadar Trek is the only route to Zanskar in winter â€” walking on a frozen river for 7 days.', icon: 'bi-snow2', color: '#5499c7' },
    { fact: 'Ladakh was an independent kingdom for over 400 years under the Namgyal dynasty.', icon: 'bi-crown', color: '#7c3aed' },
    { fact: 'Pangong Tso changes color throughout the day â€” from blue to green to grey to red at sunset.', icon: 'bi-palette', color: '#dc2626' },
