  ...
  animals: WildlifeData[] = [
    {
      ...
      description: 'The Ghost of the Mountains — Ladakh is the global stronghold for this elusive big cat, deeply entrenched in both cutting-edge science and Ancient Himalayan mythology.',
      ...
      photos: [
        ...
        { title: 'agile Descent', image: 'https://images.unsplash.com/photo-1516233758813-a38d024919c5?auto=format&fit=crop&q=80&w=800', icon: 'bi-chevron-double-down', location: 'Markha Valley', desc: 'Incredible agility on near-vertical rock faces — snow leopards can descend cliffs no other big cat would attempt.' },
      ],
      facts: [
        { icon: 'bi-rulers', label: 'Body Length', value: '100–130 cm (+ 100cm tail)' },
        { icon: 'bi-speedometer2', label: 'Weight', value: '27–54 kg' },
        { icon: 'bi-map', label: 'Home Range', value: '20–40 sq km' },
        { icon: 'bi-thermometer-snow', label: 'Elevation', value: '3,000–5,400m' },
        { icon: 'bi-heart-pulse', label: 'Lifespan', value: '15–18 years (wild)' },
    ...
    },
    {
      ...
      facts: [
        { icon: 'bi-rulers', label: 'Height', value: '139–145 cm' },
        { icon: 'bi-arrows-fullscreen', label: 'Wingspan', value: '235 cm' },
        { icon: 'bi-speedometer2', label: 'Weight', value: '5.5–7 kg' },
        { icon: 'bi-geo-alt', label: 'Breeding altitude', value: '4,200–5,000m' },
    ...
    },
    {
      ...
      photos: [
        { title: 'Steppe Gallop', image: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&q=80&w=800', icon: 'bi-speedometer2', location: 'Changthang Plateau', desc: ' A herd of kiangs galloping across the vast steppe — dust clouds rising against snow-capped peaks.' },
        ...
        { title: 'Ice Forging', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-water', location: 'Indus Headwaters', desc: ' A small group fording A glacial stream — water barely reaching their powerful legs.' },
      ...
      facts: [
        { icon: 'bi-rulers', label: 'Shoulder Height', value: '132–142 cm' },
        { icon: 'bi-speedometer2', label: 'Top Speed', value: '60 km/h' },
        { icon: 'bi-speedometer2', label: 'Weight', value: '350–400 kg (males)' },
        { icon: 'bi-geo-alt', label: 'Elevation Range', value: '4,000–5,200m' },
    ...
    },
    {
      ...
      photos: [
        ...
        { title: 'Seasonal Dig', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-search', location: 'Rangdum', desc: 'Using powerful claws to dig out A marmot burrow — A key food source in summer.' },
      ...
      facts: [
        { icon: 'bi-rulers', label: 'Body Length', value: '150–200 cm' },
        { icon: 'bi-speedometer2', label: 'Weight', value: '130–250 kg (male)' },
        { icon: 'bi-calendar', label: 'Hibernation', value: '5–6 months' },
        { icon: 'bi-geo-alt', label: 'Primary Range', value: 'Suru / Drass Valleys' },
        { icon: 'bi-heart-pulse', label: 'Lifespan', value: '20–25 years' },
    ...
    },
    {
      ...
      photos: [
        ...
        { title: 'Grassland Prowl', image: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&q=80&w=800', icon: 'bi-search', location: 'Hanle Plains', desc: ' A solitary wolf moving through the golden grasslands — pale coat blending with the terrain.' },
        { title: 'active Den', image: 'https://images.unsplash.com/photo-1581791534721-e599df4417f7?auto=format&fit=crop&q=80&w=800', icon: 'bi-house', location: 'Puga Valley', desc: ' A hillside den entrance with fresh digging — A pack\'s spring breeding site.' },
      ...
      facts: [
        { icon: 'bi-rulers', label: 'Body Length', value: '110–130 cm' },
        { icon: 'bi-speedometer2', label: 'Weight', value: '25–35 kg' },
        { icon: 'bi-people-fill', label: 'Pack Size', value: '3–8 wolves' },
        { icon: 'bi-geo-alt', label: 'Elevation', value: '3,800–5,000m' },
        { icon: 'bi-heart-pulse', label: 'Lifespan', value: '10–12 years (wild)' },
    ...
    },
    {
      ...
      photos: [
        ...
        { title: 'Winter Descent', image: 'https://images.unsplash.com/photo-1605649487212-47bdab064df7?auto=format&fit=crop&q=80&w=800', icon: 'bi-snow2', location: 'Indus Valley', desc: ' A small herd descending to lower elevations during winter — visible from the Leh highway.' },
      ],
      facts: [
        { icon: 'bi-rulers', label: 'Horn Length', value: 'Up to 130 cm' },
        { icon: 'bi-speedometer2', label: 'Weight (male)', value: '90–130 kg' },
        { icon: 'bi-rulers', label: 'Shoulder Height', value: '80–100 cm' },
        { icon: 'bi-thermometer-snow', label: 'Elevation Range', value: '3,800–5,200m' },
        { icon: 'bi-heart-pulse', label: 'Lifespan', value: '15–20 years (wild)' },
      ...
      didYouKnow: [
        'The Himalayan Ibex is the primary prey of the snow leopard — one ibex provides A snow leopard with food for 2–3 weeks.',
        'Their horns can weigh up to 10 kg — more than 10% of their body weight — yet they navigate sheer cliffs effortlessly.',
