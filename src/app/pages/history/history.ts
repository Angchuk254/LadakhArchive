...
export class History {
  ...
  constructor() {
    const title = 'History of Ladakh â€” From ancient Kingdoms to Union Territory';
  ...
  timeline = [
    ...
    },
    {
      ...
      events: [
        ...
        { year: '2020â€“Present', title: 'Safeguards Movement', desc: 'Ladakhi leaders and civil society unite to demand constitutional safeguards (6th Schedule or statehood) to protect land, culture, and identity.' },
      ]
    },
  ];

  kingdoms = [
    { name: 'Kingdom of Maryul', period: '~930â€“1834 aD', desc: 'The independent Ladakhi kingdom founded by Nyima-Gon, lasting nearly 900 years under the Namgyal dynasty.', icon: 'bi-gem' },
    { name: 'Zanskar Kingdom', period: '10thâ€“19th Century', desc: 'a semi-independent vassal kingdom in the Zanskar valley, with its own line of rulers and distinct cultural identity.', icon: 'bi-snow2' },
    { name: 'Nubra Region', period: 'ancient', desc: 'The northern frontier â€” a vital trade gateway to Central asia through the Karakoram Pass.', icon: 'bi-signpost-split-fill' },
  ];
  ...
  keyFigures = [
    ...
    { name: 'Sengge Namgyal', title: 'The Lion King', period: '1570â€“1642', desc: 'The most celebrated Namgyal king who built Leh Palace, Hemis Monastery, and expanded Ladakh\'s borders.' },
    { name: 'Deldan Namgyal', title: 'The Diplomat King', period: '1642â€“1694', desc: 'Navigated the treacherous Tibetan-Mughal conflict and preserved Ladakh\'s sovereignty through diplomacy.' },
    { name: 'Zorawar Singh', title: 'Dogra General', period: '1786â€“1841', desc: 'Military commander who conquered Ladakh for the Dogra rulers; a pivotal and controversial figure.' },
    { name: 'Kushok Bakula Rinpoche', title: 'architect of Modern Ladakh', period: '1917â€“2003', desc: 'Monk, politician, and diplomat who championed Ladakhi rights, education, and development post-independence.' },
  ...
  historicalMaps = [
    ...
    { era: 'Namgyal Golden age', year: '~1553', extent: 'Zanskar to Rudok (W. Tibet)', color: '#059669', icon: 'bi-arrows-angle-expand', controlPct: 85, desc: 'Under Tsewang Namgyal, Ladakh reaches its greatest territorial extent â€” from Baltistan to Western Tibet.' },
  ...
  // ===== Wars & Conflicts =====
  wars = [
    { name: 'Tibetan-Ladakhi-Mughal War', year: '1679â€“1684', result: 'Treaty of Tingmosgang', severity: 75, icon: 'bi-shield-x', color: '#7c3aed', desc: 'Tibet invaded Ladakh with Mongol support. King Deldan Namgyal sought Mughal help, who drove back the Tibetans. The treaty cost Ladakh its western Tibetan territories and forced the construction of a mosque in Leh.' },
    ...
    { name: 'Dogra-Tibetan War', year: '1841â€“1842', result: 'Treaty of Chushul', severity: 65, icon: 'bi-snow', color: '#1a365d', desc: 'Zorawar Singh pushed into Western Tibet but was killed in battle at Taklakot. Tibetan forces counter-invaded Ladakh but were repelled. The Treaty of Chushul restored pre-war boundaries.' },
    { name: 'Tribal Raid & Kashmir War', year: '1947â€“1948', result: 'Leh secured by India', severity: 70, icon: 'bi-crosshair', color: '#059669', desc: 'Following Partition, Pakistani tribal raiders invaded Ladakh. a desperate defense of Leh by locals and Indian forces secured the town, though Gilgit-Baltistan remained under Pakistan.' },
  ...
  monuments = [
    {
      ...
      visitingHours: '7:00 aM â€“ 4:00 PM (aprilâ€“October)',
      entryFee: 'â‚¹30 (Indian), â‚¹100 (Foreign)',
    ...
    },
    {
      ...
      visitingHours: '8:00 aM â€“ 6:00 PM (all Year)',
      entryFee: 'â‚¹50 (Indian), â‚¹200 (Foreign)',
    ...
    },
    {
      ...
      visitingHours: '8:00 aM â€“ 6:00 PM (Closed during winter months)',
      entryFee: 'â‚¹50 (Photography prohibited inside temples)',
    ...
    },
    {
      ...
      visitingHours: '7:00 aM â€“ 6:00 PM (all Year)',
      entryFee: 'â‚¹30',
    ...
    },
    {
      ...
      visitingHours: '6:00 aM â€“ 8:00 PM (all Year)',
      entryFee: 'â‚¹30',
      ...
      gallery: [
        { title: 'Maitreya Buddha Statue', desc: 'The towering 32-metre Maitreya facing down the Shyok Valley â€” Ladakh\'s most iconic modern landmark.' },
  ...
  // ===== Historical Quotes =====
  quotes = [
    { text: 'Ladakh is a country where the weights of the atmosphere seem to have been taken off one\'s shoulders â€” the air is so light, so pure, so exhilarating.', author: 'alexander Cunningham', role: 'British archaeologist', year: '1854' },
    ...
    { text: 'Of all the places I have seen in India, Ladakh struck me as the most extraordinary â€” a living museum of Central asian history.', author: 'Xuanzang (attributed)', role: 'Chinese Buddhist Monk', year: '~640 aD' },
    { text: 'Our land may be small, our passes may be high, our winters may be harsh â€” but our spirit, like the Indus, flows on forever.', author: 'Kushok Bakula Rinpoche', role: '19th Incarnation, Ladakhi Leader', year: '1989' },
  ];
}
